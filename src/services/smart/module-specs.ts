...
const AI_FIELD_OVERRIDES: Record<string, { purpose: string; fields: string[]; example?: Record<string, unknown> }> = {
  ...
  dryer: {
    purpose: 'Animated dryer card with cycle status, remaining time, controls, and metrics.',
    fields: ['entity', 'layout', 'show_title', 'show_status', 'show_controls', 'show_metrics', 'enable_animations'],
    example: {
      type: 'dryer',
      entity: 'select.dryer',
  ...
  dishwasher: {
    purpose: 'Animated dishwasher card with cycle status, remaining time, controls, and wash options.',
    fields: ['entity', 'layout', 'show_title', 'show_status', 'show_controls', 'show_metrics', 'enable_animations'],
    example: {
      type: 'dishwasher',
      entity: 'select.dishwasher',
      layout: 'standard',
      show_title: true,
      show_status: true,
      enable_animations: true,
  ...
  fridge: {
    purpose: 'Refrigerator card with fridge/freezer temperatures, setpoints, door alerts, and feature switches.',
    fields: ['entity', 'layout', 'show_title', 'show_status', 'show_temperatures', 'show_metrics', 'enable_animations'],
    example: {
      type: 'fridge',
      entity: 'sensor.refrigerator_fridge_temperature',
      layout: 'standard',
      show_title: true,
      show_status: true,
      enable_animations: true,
  ...
  range: {
    purpose: 'Kitchen range/oven card with cooktop burner indicators, oven status, temperature and set point, and light control.',
    fields: ['entity', 'layout', 'show_title', 'show_status', 'show_temperatures', 'show_cooktop', 'show_controls', 'enable_animations'],
    example: {
      type: 'range',
...
const ENTITY_DOMAIN_OVERRIDES: Record<string, string[]> = {
  ...
  fridge: ['sensor', 'binary_sensor', 'number', 'switch', 'select', 'input_select'],
  range: ['sensor', 'binary_sensor', 'select', 'input_select', 'light', 'button', 'switch', 'number'],
  todo_list: ['todo'],
  weather: ['weather'],
  separator: ['*'],
  text: ['*'],
