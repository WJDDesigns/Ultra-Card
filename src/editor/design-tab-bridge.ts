...
export function extractModuleDesignProperties(module: CardModule): DesignProperties {
  ...
  return {
    ...
    text_shadow_h: design.text_shadow_h ?? m.text_shadow_h,
    text_shadow_v: design.text_shadow_v ?? m.text_shadow_v,
    text_shadow_blur: design.text_shadow_blur ?? m.text_shadow_blur,
    text_shadow_color: design.text_shadow_color ?? m.text_shadow_color,
    transform_perspective: design.transform_perspective,
    transform_rotate_x: design.transform_rotate_x,
    transform_rotate_y: design.transform_rotate_y,
    transform_rotate_z: design.transform_rotate_z,
