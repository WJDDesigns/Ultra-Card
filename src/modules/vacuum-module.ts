    ...
    switch (section.type) {
      ...
      case 'map':
        ...
        return html`
          ...
          ${isSwipeMode ? html`
            <div class="vacuum-setting-desc" style="margin: 8px 0; padding: 8px; background: rgba(var(--rgb-primary-color), 0.1); border-radius: var(--uc-r-6, 6px); font-size: 12px;">
  ...
  private renderDndStatus(module: VacuumModule, hass: HomeAssistant, settings?: VacuumDisplaySection['settings'], config?: UltraCardConfig): TemplateResult {
    ...
    return html`
      <div 
        ...
        style="${buttonStyle} border-radius: var(--uc-r-8, 8px); padding: 8px 12px; cursor: ${isToggleable ? 'pointer' : 'default'};"
