            ...
            : style === 'progress_bar'
              ? html`
                  <div style="margin-bottom: 16px;">
                    ...
                    <div style="height: 12px; background: var(--divider-color); border-radius: var(--uc-r-6, 6px); overflow: hidden;">
                      <div
                        style="height: 100%; width: ${progressPct}%; background: var(--primary-color); border-radius: var(--uc-r-6, 6px); transition: width 0.3s ease;"
                      ></div>
                    </div>
                  </div>
                `
