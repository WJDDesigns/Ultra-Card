...
export class UltraVampirePowerModule extends BaseUltraModule {
  ...
  private _renderSensorsSection(
    ...
    return html`
      ...
      >
        ...
        <div
          style="display: flex; align-items: center; gap: 10px; padding: 12px 14px; border-radius: var(--uc-r-8, 8px); background: rgba(var(--rgb-primary-color), 0.08); margin-bottom: 16px;"
        >
          <ha-icon
  ...
  private _renderSkeleton(
    ...
    return html`
      ...
      >
        ...
        <div class="uc-vp-shimmer" style="height: 30px; width: 62%; border-radius: var(--uc-r-8, 8px);"></div>
        <div
          class="uc-vp-shimmer"
          style="height: 12px; margin-top: 12px; border-radius: var(--uc-r-6, 6px);"
        ></div>
      </div>
          ...
          i => html`
            ...
            >
              ...
              <div style="flex: 1; min-width: 0;">
                <div
                  class="uc-vp-shimmer"
                  style="height: 12px; width: ${70 - i * 12}%; border-radius: var(--uc-r-6, 6px);"
                ></div>
                <div
                  class="uc-vp-shimmer"
                  style="height: 8px; margin-top: 8px; width: ${55 - i * 10}%; border-radius: var(--uc-r-5, 5px);"
                ></div>
              </div>
              <div
                class="uc-vp-shimmer"
                style="width: 52px; height: 16px; border-radius: var(--uc-r-6, 6px); flex-shrink: 0;"
              ></div>
            </div>
          `
        )}
    ...
    return html`
      ...
      >
        ...
        ${totals.totalStandbyWatts > 0
          ? html`
              <div
                style="display: flex; height: 12px; border-radius: var(--uc-r-6, 6px); overflow: hidden; background: rgba(127,127,127,0.18);"
                role="img"
      ...
      <div style="display: flex; flex-direction: column; gap: 8px;">
        ${items.map((a, index) => {
          ...
          return html`
            ...
            >
              <div
                style="display: flex; align-items: center; justify-content: center; width: 22px; height: 22px; border-radius: var(--uc-r-6, 6px); background: ${color}22; color: ${color}; font-size: 12px; font-weight: 700; flex-shrink: 0;"
              >
                ${index + 1}
              </div>
              <ha-icon
              ...
              <div style="flex: 1; min-width: 0;">
                ...
                ${m.show_bars !== false
                  ? html`
                      <div
                        style="height: 6px; border-radius: var(--uc-r-4, 4px); background: rgba(127,127,127,0.18); margin-top: 7px; overflow: hidden;"
                      >
      ...
      <div class="uc-vp-grid">
        ${items.map(a => {
          ...
          return html`
            <div
              class="uc-vp-tile"
              style="position: relative; padding: 14px 12px; border-radius: var(--uc-r-12, 12px); text-align: center; background: ${color}18; border: 1px solid ${color}44;"
              @pointerdown=${gestures.onPointerDown}
              @pointermove=${gestures.onPointerMove}
              @pointerup=${gestures.onPointerUp}
              @pointerleave=${gestures.onPointerLeave}
  ...
  private _renderSavingsHint(
    ...
    return html`
      <div
        style="display: flex; align-items: flex-start; gap: 10px; margin-top: 12px; padding: 12px 14px; border-radius: var(--uc-r-12, 12px); background: rgba(127,127,127,0.1);"
      >
        <ha-icon
