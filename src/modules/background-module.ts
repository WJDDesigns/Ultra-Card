  ...
  renderPreview(
    ...
    if (showPlaceholder) {
      ...
      return this.wrapWithAnimation(html`
        <div
          class="${hoverClass}"
          style="${designStyles}; padding: 16px; text-align: center; color: var(--secondary-text-color); font-style: italic; background: rgba(var(--rgb-primary-color), 0.05); border-radius: var(--uc-r-8, 8px); border: 2px dashed var(--divider-color);"
        >
          <ha-icon
            icon="mdi:image-outline"
