  ...
  return html`
    ...
    <div class="module-general-settings">
      ...
      <div
        ...
        style="background: var(--secondary-background-color); border-radius: var(--uc-r-12, 12px); padding: 20px; margin-bottom: 20px; border: 1px solid rgba(var(--rgb-primary-color), 0.12);"
      >
        <div
          class="section-title"
