"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[4116],{4383:(t,e,i)=>{i.r(e),i.d(e,{UltraGraphsModule:()=>v});var r=i(5183),o=i(7475),a=i(5320),n=i(9327),s=i(5121),l=i(5262),d=i(8869),c=i(5147),p=i(8938),h=i(8465),g=i(6477),u=(i(9009),i(7921),i(6990)),y=i(9760),m=i(6478),_=i(1001);class v extends o.m{constructor(){super(...arguments),this.metadata={type:"graphs",title:"Graphs",description:"Display interactive charts and graphs with Home Assistant data",author:"WJD Designs",version:"1.0.0",icon:"mdi:chart-line",category:"data",tags:["charts","graphs","data","visualization","statistics","analytics"]},this._updateInterval=null,this._historyData={},this._historyError={},this._historyLoading={},this._deferredHistoryScheduled={},this._templateResults={},this.clickTimeout=null,this.holdTimeout=null,this.isHolding=!1,this.expandedEntities=new Set,this.DEFAULT_COLORS=["#2196F3","#4CAF50","#FF9800","#F44336","#9C27B0","#00BCD4","#FFEB3B","#795548","#607D8B","#E91E63"],this.FORECAST_ATTRIBUTE_LABELS={temperature:"Temperature",precipitation:"Precipitation",wind_speed:"Wind Speed",humidity:"Humidity",pressure:"Pressure",cloud_coverage:"Cloud Coverage"},this.FORECAST_ATTRIBUTE_UNITS={temperature:"°",precipitation:"mm",wind_speed:"km/h",humidity:"%",pressure:"hPa",cloud_coverage:"%"}}_getCacheStore(){const t=window;if(!t.__ultraGraphsCache)try{const e=localStorage.getItem("__ultraGraphsCache");t.__ultraGraphsCache=e?JSON.parse(e):{}}catch(e){t.__ultraGraphsCache={}}return t.__ultraGraphsCache}_persistCacheStore(t){try{localStorage.setItem("__ultraGraphsCache",JSON.stringify(t))}catch(t){}}_makeCacheKey(t){return"forecast"===(t.data_source||"history")?`forecast::${t.forecast_entity}::${t.forecast_type}::${t.time_period}`:`history::${(t.entities||[]).filter((t=>t.entity)).map((t=>`${t.entity}|${t.attribute||"state"}`)).join(";")}::${t.time_period}`}_tryReadCache(t){const e=this._getCacheStore(),i=this._makeCacheKey(t),r=e[i];if(!r)return null;const o=Date.now();return r.expiresAt&&r.expiresAt>o&&r.data?r.data:(delete e[i],this._persistCacheStore(e),null)}_writeCache(t,e){const i=this._getCacheStore();i[this._makeCacheKey(t)]={expiresAt:Date.now()+3e5,data:e},this._persistCacheStore(i)}createDefault(t,e){return{id:t||this.generateId("graphs"),type:"graphs",name:"New Graph",data_source:"history",forecast_type:"hourly",forecast_entity:"",chart_type:"line",entities:[],time_period:"24h",title:"Chart",chart_width:"100%",chart_width_percent:100,chart_height:345,background_color:"transparent",show_title:!0,chart_alignment:"center",show_display_name:!0,show_entity_value:!0,info_position:"top_left",title_font_size:12,value_font_size:16,show_legend:!0,legend_position:"bottom_left",show_grid:!0,show_time_intervals:!1,smooth_curves:!0,show_tooltips:!0,show_slice_labels:!0,bar_display_limit:0,chart_layout:"default",use_fixed_y_axis:!1,y_axis_min:void 0,y_axis_max:void 0,tap_action:void 0,hold_action:void 0,double_tap_action:void 0,template_mode:!1,template:"",display_mode:"always",display_conditions:[]}}getChartTypeOptions(t){return[{value:"line",label:(0,m.kg)("editor.graphs.types.line",t,"Line Chart")},{value:"bar",label:(0,m.kg)("editor.graphs.types.bar",t,"Bar Chart")},{value:"pie",label:(0,m.kg)("editor.graphs.types.pie",t,"Pie Chart")},{value:"donut",label:(0,m.kg)("editor.graphs.types.donut",t,"Donut Chart")}]}getTimePeriodOptions(t,e){const i="forecast"===e?"Next":"Last";return[{value:"1h",label:(0,m.kg)("editor.graphs.period.1h",t,`${i} Hour`)},{value:"3h",label:(0,m.kg)("editor.graphs.period.3h",t,`${i} 3 Hours`)},{value:"6h",label:(0,m.kg)("editor.graphs.period.6h",t,`${i} 6 Hours`)},{value:"12h",label:(0,m.kg)("editor.graphs.period.12h",t,`${i} 12 Hours`)},{value:"24h",label:(0,m.kg)("editor.graphs.period.24h",t,`${i} 24 Hours`)},{value:"2d",label:(0,m.kg)("editor.graphs.period.2d",t,`${i} 2 Days`)},{value:"7d",label:(0,m.kg)("editor.graphs.period.7d",t,`${i} Week`)},{value:"30d",label:(0,m.kg)("editor.graphs.period.30d",t,`${i} Month`)},{value:"90d",label:(0,m.kg)("editor.graphs.period.90d",t,`${i} 3 Months`)},{value:"365d",label:(0,m.kg)("editor.graphs.period.365d",t,`${i} Year`)}]}getAggregationOptions(t){return[{value:"mean",label:(0,m.kg)("editor.graphs.agg.mean",t,"Average")},{value:"sum",label:(0,m.kg)("editor.graphs.agg.sum",t,"Sum")},{value:"min",label:(0,m.kg)("editor.graphs.agg.min",t,"Minimum")},{value:"max",label:(0,m.kg)("editor.graphs.agg.max",t,"Maximum")},{value:"median",label:(0,m.kg)("editor.graphs.agg.median",t,"Median")},{value:"first",label:(0,m.kg)("editor.graphs.agg.first",t,"First Value")},{value:"last",label:(0,m.kg)("editor.graphs.agg.last",t,"Last Value")},{value:"count",label:(0,m.kg)("editor.graphs.agg.count",t,"Count")},{value:"delta",label:(0,m.kg)("editor.graphs.agg.delta",t,"Change")}]}getLegendPositionOptions(t){return[{value:"top",label:(0,m.kg)("editor.graphs.position.top",t,"Top")},{value:"bottom",label:(0,m.kg)("editor.graphs.position.bottom",t,"Bottom")},{value:"left",label:(0,m.kg)("editor.graphs.position.left",t,"Left")},{value:"right",label:(0,m.kg)("editor.graphs.position.right",t,"Right")},{value:"none",label:(0,m.kg)("editor.graphs.position.hidden",t,"Hidden")}]}renderGeneralTab(t,e,i,o){var a,n,s,l,d,c,p,g,u,y,_,v,b,x,f,w,$,k,S;const C=t,z=(null===(a=null==e?void 0:e.locale)||void 0===a?void 0:a.language)||"en";return r.qy`
      <div class="uc-graphs-general-tab">
        ...
        >
          ...
          >
            ...
            ${(0,m.kg)("editor.graphs.chart_type.title",z,"Chart Type")}
          </div>

          ${this.renderFieldSection((0,m.kg)("editor.graphs.chart_type.type",z,"Type"),(0,m.kg)("editor.graphs.chart_type.desc",z,"Select the visualization style for your data."),e,{chart_type:C.chart_type},[this.selectField("chart_type",this.getChartTypeOptions(z))],(t=>{const e=t.detail.value.chart_type;e!==C.chart_type&&(o({chart_type:e}),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}))}
        </div>
        ...
        >
          ...
          >
            <ha-icon icon="mdi:database" style="color: var(--primary-color);"></ha-icon>
            ${"forecast"===C.data_source?(0,m.kg)("editor.graphs.forecast_attributes.title",z,"Forecast Attributes"):(0,m.kg)("editor.graphs.data_sources.title",z,"Data Sources")}
          </div>
          ${"forecast"===C.data_source?r.qy`<div
              ...
              >
                ${(0,m.kg)("editor.graphs.forecast_attributes.desc",z,"Select which forecast values to display from the weather entity configured above. Each attribute will be shown as a separate line on the graph.")}
              </div>`:""}
          ...
          <div class="entities-grid" style="display: grid; gap: 12px;">
                ...
                >
                  ...
                  >
                    ...
                    <div style="display: grid; gap: 12px;">
                      ...
                      ${"forecast"!==C.data_source?h.Q.renderField((0,m.kg)("editor.graphs.entity.label",z,"Entity"),(0,m.kg)("editor.graphs.entity.desc",z,"Select an entity to plot."),e,{entity:t.entity||""},[h.Q.createSchemaItem("entity",{entity:{}})],(t=>{var r,a;this._updateEntity(C,i,{entity:(null===(r=t.detail.value)||void 0===r?void 0:r.entity)||(null===(a=t.detail.value)||void 0===a?void 0:a.entity)||t.detail.value},o,e)})):""}

                      <!-- Forecast Attribute Selection (Forecast Mode - Always Visible) -->
                      ${"forecast"===C.data_source?this.renderFieldSection((0,m.kg)("editor.graphs.entity.forecast_attr",z,"Forecast Attribute"),(0,m.kg)("editor.graphs.entity.forecast_attr_desc",z,"Which forecast value to plot on the graph."),e,{forecast_attribute:t.forecast_attribute||"temperature"},[this.selectField("forecast_attribute",[{value:"temperature",label:(0,m.kg)("editor.graphs.forecast.temp",z,"Temperature")},{value:"precipitation",label:(0,m.kg)("editor.graphs.forecast.precip",z,"Precipitation")},{value:"wind_speed",label:(0,m.kg)("editor.graphs.forecast.wind",z,"Wind Speed")},{value:"humidity",label:(0,m.kg)("editor.graphs.forecast.humidity",z,"Humidity")},{value:"pressure",label:(0,m.kg)("editor.graphs.forecast.pressure",z,"Pressure")},{value:"cloud_coverage",label:(0,m.kg)("editor.graphs.forecast.clouds",z,"Cloud Coverage")}])],(r=>{const a=r.detail.value.forecast_attribute;a!==t.forecast_attribute&&this._updateEntity(C,i,{forecast_attribute:a},o,e)})):""}

                      <!-- Display Name -->
                      <input
                        type="text"
                        .value=${t.name||""}
                        placeholder="${(0,m.kg)("editor.graphs.entity.display_name_placeholder",z,"Display name (optional)")}"
                      ...
                      >
                        ...
                        <span style="font-size:13px; color: var(--primary-text-color);"
                          >${(0,m.kg)("editor.graphs.entity.use_as_card_info",z,"Use as card info")}</span
                        >
                      </label>
                    </div>
                    ...
                    >
                      <div style="padding-top: 16px; display: grid; gap: 16px;">
                        ...
                        ${"forecast"!==C.data_source?h.Q.renderField((0,m.kg)("editor.graphs.entity.attribute",z,"Attribute"),(0,m.kg)("editor.graphs.entity.attribute_desc",z,"Use entity state or select a specific attribute to track."),e,{attribute:t.attribute||""},[h.Q.createSchemaItem("attribute",{select:{options:[{value:"",label:(0,m.kg)("editor.graphs.entity.state_default",z,"State (default)")},...this._getEntityAttributes(t.entity,e)],mode:"dropdown"}})],(t=>{this._updateEntity(C,i,{attribute:t.detail.value.attribute},o,e)})):""}
                        ...
                        ${["line","area"].includes(C.chart_type)?r.qy`
                              ...
                              >
                                ...
                                >
                                  ...
                                  ></ha-switch>
                                  <span style="font-size: 13px; color: var(--primary-text-color);"
                                    >${(0,m.kg)("editor.graphs.line.show_points",z,"Show Points")}</span
                                  >
                                </label>
                                ...
                                >
                                  ...
                                  ></ha-switch>
                                  <span style="font-size: 13px; color: var(--primary-text-color);"
                                    >${(0,m.kg)("editor.graphs.line.fill_area",z,"Fill Area")}</span
                                  >
                                </label>
                              </div>
                              ...
                              >
                                <div>
                                  ...
                                  >
                                    ${(0,m.kg)("editor.graphs.line.line_width",z,"Line Width")}:
                                    ${t.line_width||2}px
                                  </label>
                                  <input
                                    type="range"
                                ...
                                ${this.renderFieldSection((0,m.kg)("editor.graphs.line.line_style",z,"Line Style"),"",e,{line_style:t.line_style||"solid"},[this.selectField("line_style",[{value:"solid",label:(0,m.kg)("editor.graphs.line_styles.solid",z,"Solid")},{value:"dashed",label:(0,m.kg)("editor.graphs.line_styles.dashed",z,"Dashed")},{value:"dotted",label:(0,m.kg)("editor.graphs.line_styles.dotted",z,"Dotted")}])],(e=>{const r=e.detail.value.line_style;r!==(t.line_style||"solid")&&(this._updateEntity(C,i,{line_style:r},o),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}))}
                              </div>
                            `:""}
                        ${["pie","donut"].includes(C.chart_type)?r.qy`
                              ...
                              >
                                ...
                                ></ha-switch>
                                <span style="font-size: 13px; color: var(--primary-text-color);"
                                  >${(0,m.kg)("editor.graphs.pie.show_title",z,"Show Title in Slice")}</span
                                >
                              </label>
                              <label
                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; padding: 8px; border-radius: 6px; background: var(--secondary-background-color);"
                              >
                                ...
                                ></ha-switch>
                                <span style="font-size: 13px; color: var(--primary-text-color);"
                                  >${(0,m.kg)("editor.graphs.pie.show_value",z,"Show Value in Slice")}</span
                                >
                              </label>
                            `:""}
                      </div>
                    ...
                    <div style="display:flex; justify-content:center; margin-top: 12px;">
                      ...
                      >
                        <span style="display:inline-flex; align-items:center; gap:6px;">
                          ...
                          ></ha-icon>
                          <span
                            >${(0,m.kg)("editor.graphs.entity.expand_options",z,"Expand Options")}</span
                          >
                        </span>
                      </ha-button>
                    </div>
                ...
                "
                  >
                    ...
                    <div style="font-size: 16px; margin-bottom: 4px; font-weight: 500;">
                      ${(0,m.kg)("editor.graphs.data_sources.no_entities",z,"No entities added")}
                    </div>
                    <div style="font-size: 14px; opacity: 0.7;">
                      ${(0,m.kg)("editor.graphs.data_sources.add_first_entity",z,"Add your first entity to create a chart")}
                    </div>
                  </div>
                `:""}
            ...
            >
              ...
              ${(0,m.kg)("editor.graphs.data_sources.add_entity",z,"Add Entity")}
            </ha-button>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            ${(0,m.kg)("editor.graphs.display.title",z,"Display Options")}
          </div>
          ...
          >
            ...
            >
              ...
              ></ha-switch>
              <span>${(0,m.kg)("editor.graphs.display.show_title",z,"Show Graph Title")}</span>
            </label>
            ...
            >
              ...
              ></ha-switch>
              <span>${(0,m.kg)("editor.graphs.display.show_value",z,"Show Graph Value")}</span>
            </label>
            ...
            ${!1!==C.show_title?r.qy`<div>
                  ...
                  >
                    ${(0,m.kg)("editor.graphs.display.chart_title",z,"Chart Title")}
                  </label>
                  <input
                    type="text"
                    .value=${C.title||""}
                    placeholder="${(0,m.kg)("editor.graphs.display.chart_title_placeholder",z,"Enter chart title")}"
            ...
            ${!1!==C.show_title?r.qy`<div>
                  <label
                    style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
                  >
                    ${(0,m.kg)("editor.graphs.display.title_font_size",z,"Title Font Size")}
                  </label>
                  <div
                  ...
                  >
                    ...
                    <button
                      ...
                      title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default ({value})").replace("{value}","12px")}"
                      style="
                        width: 32px;
                        height: 32px;
                        padding: 0;
            ...
            ${!1!==C.show_entity_value?r.qy`<div>
                  <label
                    style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
                  >
                    ${(0,m.kg)("editor.graphs.display.value_font_size",z,"Value Font Size")}
                  </label>
                  <div
                    style="display: grid; grid-template-columns: 1fr auto auto; gap: 8px; align-items: center; box-sizing: border-box; width: 100%;"
                  >
                    ...
                    <button
                      ...
                      title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default ({value})").replace("{value}","16px")}"
                      style="
                        width: 32px;
                        height: 32px;
                        padding: 0;
            ...
            ${"forecast"!==C.data_source?this.renderFieldSection((0,m.kg)("editor.graphs.display.time_period",z,"Time Period"),(0,m.kg)("editor.graphs.display.time_period_desc",z,"How much historical data to show."),e,{time_period:C.time_period},[this.selectField("time_period",this.getTimePeriodOptions(z,C.data_source))],(t=>{const i=t.detail.value.time_period;if(i===C.time_period)return;o({time_period:i}),delete this._historyData[C.id],delete this._historyError[C.id],delete this._historyLoading[C.id],delete this._deferredHistoryScheduled[C.id];const r=Object.assign(Object.assign({},C),{time_period:i});this._loadHistoryData(r,e),this._triggerHistoryLoad(r,e),this.requestUpdate(),setTimeout((()=>{this.triggerPreviewUpdate()}),50)})):""}
            ...
            ${"forecast"===C.data_source?r.qy`<div
                  ...
                  >
                    ...
                    >
                      ${(0,m.kg)("editor.graphs.forecast_info.title",z,"Forecast Display")}
                    </div>
                    <div
                      style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;"
                    >
                      ${(0,m.kg)("editor.graphs.forecast_info.desc",z,"Forecasts display all available data from your weather service. The forecast type (hourly/daily) determines the time range shown.")}
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      >
                        ${(0,m.kg)("editor.graphs.forecast_limit.hours",z,"Limit Hours")}
                      </label>
                      <ha-textfield
                        type="number"
                        min="0"
                        ...
                        style="width: 100%;"
                        placeholder="0"
                        helper="${(0,m.kg)("editor.graphs.forecast_limit.hours_desc",z,"0 = show all")}"
                      ></ha-textfield>
                    </div>
                    <div>
                      <label
                        style="font-size: 13px; color: var(--primary-text-color); display: block; margin-bottom: 6px;"
                      >
                        ${(0,m.kg)("editor.graphs.forecast_limit.days",z,"Limit Days")}
                      </label>
                      <ha-textfield
                        type="number"
                        min="0"
                        ...
                        style="width: 100%;"
                        placeholder="0"
                        helper="${(0,m.kg)("editor.graphs.forecast_limit.days_desc",z,"Days override hours")}"
                      ></ha-textfield>
                    </div>
                  </div>`:""}

            <!-- Normalize Values Toggle (only show when multiple entities) -->
            ${((null===(y=C.entities)||void 0===y?void 0:y.filter((t=>"forecast"===C.data_source?t.forecast_attribute:t.entity)).length)||0)>1?r.qy`
                  <div style="margin-bottom: 16px;">
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                      ...
                      <span style="font-size: 14px;"
                        >${(0,m.kg)("editor.graphs.display.normalize_values",z,"Normalize values to same scale")}</span
                      >
                    </label>
                    <div
                      style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px; margin-left: 40px;"
                    >
                      ${(0,m.kg)("editor.graphs.display.normalize_desc",z,"Useful when comparing entities with different units (e.g., % vs miles)")}
                    </div>
                  </div>
                `:""}
            ...
            ${["line","bar"].includes(C.chart_type)?r.qy`
                  <div style="margin-bottom: 16px;">
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                      ...
                      ></ha-switch>
                      <span style="font-size: 14px;"
                        >${(0,m.kg)("editor.graphs.display.use_fixed_y_axis",z,"Use Fixed Y-Axis Scale")}</span
                      >
                    </label>
                    <div
                      style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px; margin-left: 40px;"
                    >
                      ${(0,m.kg)("editor.graphs.display.use_fixed_y_axis_desc",z,"Set fixed min/max values instead of auto-scaling. Useful for consistent scales across multiple graphs or time periods.")}
                    </div>
                  </div>
                `:""}
                  ...
                  >
                    ...
                    <div style="margin-bottom: 16px;">
                      <label
                        style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
                      >
                        ${(0,m.kg)("editor.graphs.display.y_axis_min",z,"Minimum Value")}
                      </label>
                      <div
                      ...
                      >
                        ...
                        <button
                          ...
                          title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default ({value})").replace("{value}","0")}"
                          style="
                            width: 32px;
                            height: 32px;
                            padding: 0;
                    ...
                    <div>
                      <label
                        style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
                      >
                        ${(0,m.kg)("editor.graphs.display.y_axis_max",z,"Maximum Value")}
                      </label>
                      <div
                        style="display: grid; grid-template-columns: 1fr auto; gap: 8px; align-items: center;"
                      >
                        ...
                        <button
                          ...
                          title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default ({value})").replace("{value}","100")}"
                          style="
                            width: 32px;
                            height: 32px;
                            padding: 0;
            ...
            <div>
              <label
                style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
              >
                ${(0,m.kg)("editor.graphs.display.chart_height",z,"Chart Height")}
              </label>
              <div
                style="display: grid; grid-template-columns: 1fr auto auto; gap: 8px; align-items: center; box-sizing: border-box; width: 100%;"
              >
                ...
                <button
                  ...
                  title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default ({value})").replace("{value}","345px")}"
                  style="
                    width: 32px;
                    height: 32px;
                    padding: 0;
            ...
            <div>
              <label
                style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
              >
                ${(0,m.kg)("editor.graphs.display.chart_width",z,"Chart Width (%)")}
              </label>
              <div
                style="display: grid; grid-template-columns: 1fr auto auto; gap: 8px; align-items: center; box-sizing: border-box; width: 100%;"
              >
              ...
              <div style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;">
                ${(0,m.kg)("editor.graphs.display.chart_width_desc",z,"Percentage of the available module width. Alignment controls placement.")}
              </div>
            </div>
            ${this.renderFieldSection((0,m.kg)("editor.graphs.display.info_position",z,"Info Position"),(0,m.kg)("editor.graphs.display.info_position_desc",z,"Position of the overlay showing the name/value."),e,{info_position:C.info_position||"top_left"},[this.selectField("info_position",[{value:"top_left",label:(0,m.kg)("editor.graphs.position.top_left",z,"Top Left")},{value:"top_right",label:(0,m.kg)("editor.graphs.position.top_right",z,"Top Right")},{value:"bottom_left",label:(0,m.kg)("editor.graphs.position.bottom_left",z,"Bottom Left")},{value:"bottom_right",label:(0,m.kg)("editor.graphs.position.bottom_right",z,"Bottom Right")},{value:"middle",label:(0,m.kg)("editor.graphs.position.middle",z,"Middle")}])],(t=>{const e=t.detail.value.info_position;e!==(C.info_position||"top_left")&&(o({info_position:e}),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}))}

            <!-- Legend Position -->
            ${!1!==C.show_legend?this.renderFieldSection((0,m.kg)("editor.graphs.display.legend_position",z,"Legend Position"),(0,m.kg)("editor.graphs.display.legend_position_desc",z,"Where to place the legend when enabled."),e,{legend_position:C.legend_position||"bottom_left"},[this.selectField("legend_position",[{value:"bottom_left",label:(0,m.kg)("editor.graphs.position.bottom_left",z,"Bottom Left")},{value:"bottom_right",label:(0,m.kg)("editor.graphs.position.bottom_right",z,"Bottom Right")},{value:"top_left",label:(0,m.kg)("editor.graphs.position.top_left",z,"Top Left")},{value:"top_right",label:(0,m.kg)("editor.graphs.position.top_right",z,"Top Right")}])],(t=>{const e=t.detail.value.legend_position;e!==(C.legend_position||"bottom_left")&&(o({legend_position:e}),setTimeout((()=>{this.triggerPreviewUpdate()}),50))})):""}

            <!-- Chart Alignment -->
            ${this.renderFieldSection((0,m.kg)("editor.graphs.display.chart_alignment",z,"Chart Alignment"),(0,m.kg)("editor.graphs.display.chart_alignment_desc",z,"Alignment of the chart within its container."),e,{chart_alignment:C.chart_alignment||"center"},[this.selectField("chart_alignment",[{value:"left",label:(0,m.kg)("editor.graphs.position.left",z,"Left")},{value:"center",label:(0,m.kg)("editor.graphs.position.center",z,"Center")},{value:"right",label:(0,m.kg)("editor.graphs.position.right",z,"Right")}])],(t=>{const e=t.detail.value.chart_alignment;e!==(C.chart_alignment||"center")&&(o({chart_alignment:e}),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}))}
            ...
            <div style="position: relative; overflow: visible;">
              <label
                style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
              >
                ${(0,m.kg)("editor.graphs.display.background_color",z,"Background Color")}
              </label>
              <ultra-color-picker
            ...
            ${"bar"===C.chart_type?r.qy`
                  <div>
                    <label
                      style="display: block; font-size: 14px; font-weight: 500; color: var(--primary-text-color); margin-bottom: 6px;"
                    >
                      ${(0,m.kg)("editor.graphs.display.bar_display_limit",z,"Max Bars to Display")}
                    </label>
                    <div
                    ...
                    >
                      <input
                        ...
                        max="100"
                        step="1"
                        .value=${null!==($=C.bar_display_limit)&&void 0!==$?$:0}
                      ...
                      <span
                        ...
                        >${0===(null!==(k=C.bar_display_limit)&&void 0!==k?k:0)?"Unlimited":`${null!==(S=C.bar_display_limit)&&void 0!==S?S:0} bars`}</span
                      >
                      <button
                        @click=${()=>o({bar_display_limit:0})}
                        title="${(0,m.kg)("editor.fields.reset_default_value",z,"Reset to default (Unlimited)")}"
                        style="
                          width: 32px;
                          height: 32px;
                          padding: 0;
                    ...
                    <div
                      style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;"
                    >
                      ${(0,m.kg)("editor.graphs.display.bar_display_limit_desc",z,"Set to 0 or higher value to limit the number of bars shown. Useful when time period contains many data points. Set to 0 for unlimited.")}
                    </div>
                  </div>
                `:""}
            ...
            <label
              ...
              >${(0,m.kg)("editor.graphs.display.chart_options",z,"Chart Options")}</label
            >
            <div
            ...
            >
              ...
              >
                ...
                ></ha-switch>
                <span>${(0,m.kg)("editor.graphs.display.show_legend",z,"Show Legend")}</span>
              </label>
              ${"line"===C.chart_type?r.qy`<label
                  ...
                  >
                    ...
                    ></ha-switch>
                    <span>${(0,m.kg)("editor.graphs.display.show_grid",z,"Show Grid")}</span>
                  </label>`:""}
              ${"line"===C.chart_type&&!1!==C.show_grid?r.qy`<label
                  ...
                  >
                    ...
                    ></ha-switch>
                    <span
                      >${(0,m.kg)("editor.graphs.display.show_grid_values",z,"Show Grid Values")}</span
                    >
                  </label>`:""}
              ${"line"===C.chart_type?r.qy`<label
                    style="display:flex; align-items:center; gap:8px; cursor:pointer; padding:8px; border-radius:6px;"
                  >
                    ...
                    ></ha-switch>
                    <span
                      >${(0,m.kg)("editor.graphs.display.show_time_intervals",z,"Show Time Intervals")}</span
                    >
                  </label>`:""}
              ${"line"===C.chart_type?r.qy`
                    <div style="padding: 8px;">
                      <div style="font-size: 0.85rem; font-weight: 500; margin-bottom: 6px; color: var(--primary-text-color);">
                        ${(0,m.kg)("editor.graphs.display.chart_layout",z,"Chart Layout")}
                      </div>
                      <div style="display: flex; gap: 6px;">
                        <button
                          ...
                          style="
                            ...
                            padding: 8px 12px;
                            border-radius: 8px;
                            border: 1px solid ${"full"!==C.chart_layout?"var(--primary-color)":"var(--divider-color)"};
                            background: ${"full"!==C.chart_layout?"rgba(var(--rgb-primary-color, 3,169,244), 0.15)":"var(--secondary-background-color, transparent)"};
                            color: var(--primary-text-color);
                            cursor: pointer;
                            font-size: 0.82rem;
                            font-weight: 500;
              ...
              ${["pie","donut"].includes(C.chart_type)?r.qy`
                    ...
                    >
                      ...
                      ></ha-switch>
                      <span
                        >${(0,m.kg)("editor.graphs.display.add_slice_gap",z,"Add Slice Gap")}</span
                      >
                    </label>
                  `:""}
              ${"line"===C.chart_type?r.qy`
                    ...
                    >
                      ...
                      ></ha-switch>
                      <span
                        >${(0,m.kg)("editor.graphs.display.smooth_lines",z,"Smooth Lines")}</span
                      >
                    </label>
                  `:""}
              ${"line"===C.chart_type?r.qy`<label
                  ...
                  >
                    ...
                    ></ha-switch>
                    <span
                      >${(0,m.kg)("editor.graphs.display.show_tooltips",z,"Show Tooltips")}</span
                    >
                  </label>`:""}
            </div>
          </div>
    ...
    `}renderActionsTab(t,e,i,r){const o=t;return c.A.render(o,e,(t=>r(t)))}renderPreview(t,e,i,o){var d,c,p,h,u,m,_,v,b,x;const f=t,w=f,$=f.design||{};let k,S,C,z;if(f.template_mode&&f.template&&(!this._templateService&&e&&(this._templateService=new a.I(e)),e)){e.__uvc_template_strings||(e.__uvc_template_strings={});const t=this._hashString(f.template),r=`graphs_${f.id}_${t}`;if(this._templateService&&!this._templateService.hasTemplateSubscription(r)){const t=(null===(c=null===(d=f.entities)||void 0===d?void 0:d.find((t=>t.is_primary&&t.entity)))||void 0===c?void 0:c.entity)||(null===(h=null===(p=f.entities)||void 0===p?void 0:p.find((t=>t.entity)))||void 0===h?void 0:h.entity)||"",o=(f.entities||[]).filter((t=>"forecast"===f.data_source?t.forecast_attribute:t.entity)).map((t=>("forecast"===f.data_source?f.forecast_entity:t.entity)||"")).filter((t=>t)),a=o.length>1?(0,n.wI)(o,e,f.entities):(0,n.pL)(t,e,{entities:f.entities,chart_type:f.chart_type});this._templateService.subscribeToTemplate(f.template,r,(()=>{"undefined"!=typeof window&&(window._ultraCardUpdateTimer||(window._ultraCardUpdateTimer=setTimeout((()=>{window.dispatchEvent(new CustomEvent("ultra-card-template-update",{bubbles:!0,composed:!0})),window._ultraCardUpdateTimer=null}),50)))}),a,i)}const o=null===(u=e.__uvc_template_strings)||void 0===u?void 0:u[r];if(o&&""!==String(o).trim()){const t=(0,s.cv)(o);(0,s.HD)(t)||(this._templateResults[f.id]=t,t.colors&&Array.isArray(t.colors)&&(k=t.colors),t.global_color&&(S=t.global_color),void 0!==t.fill_area&&(C=t.fill_area),void 0!==t.pie_fill&&(z="number"==typeof t.pie_fill?t.pie_fill:parseFloat(String(t.pie_fill))))}}this._loadHistoryData(f,e);const T=$.color||w.color||"var(--primary-text-color)",D=(()=>{const t=$.font_size||w.font_size;if(t&&"string"==typeof t&&""!==t.trim())return/[a-zA-Z%]/.test(t)?t:`${t}px`})(),M=$.font_family||w.font_family||void 0,A=$.font_weight||w.font_weight||void 0,F=$.text_transform||w.text_transform||void 0,E=$.font_style||w.font_style||void 0,L=$.letter_spacing||w.letter_spacing||void 0,O=$.line_height||w.line_height||void 0,P=(()=>{const t=$.text_shadow_h||w.text_shadow_h,e=$.text_shadow_v||w.text_shadow_v,i=$.text_shadow_blur||w.text_shadow_blur,r=$.text_shadow_color||w.text_shadow_color;if(t||e||i||r)return`${t||"0px"} ${e||"0px"} ${i||"0px"} ${r||"rgba(0,0,0,0.2)"}`})(),U=($.background_color||w.background_color,(t={})=>{const e=[],i=t.color||T;i&&e.push(`color: ${i}`);const r=t.fontSize||D;return r&&e.push(`font-size: ${r}`),M&&e.push(`font-family: ${M}`),A&&e.push(`font-weight: ${A}`),F&&e.push(`text-transform: ${F}`),E&&e.push(`font-style: ${E}`),L&&e.push(`letter-spacing: ${L}`),O&&e.push(`line-height: ${O}`),P&&e.push(`text-shadow: ${P}`),e.join("; ")}),I=$.background_color||w.background_color||"transparent",j=this.getBackgroundImageCSS(Object.assign(Object.assign({},w),$),e),H=(0,g.U9)({color:I,image:"none"!==j?j:void 0,imageSize:$.background_size||w.background_size||"cover",imagePosition:$.background_position||w.background_position||"center",imageRepeat:$.background_repeat||w.background_repeat||"no-repeat",fallback:"transparent"}),W="full"===f.chart_layout,q=W?"0px":"8px",N=W?"0":"8px 0",B=Object.assign(Object.assign({padding:$.padding_top||$.padding_bottom||$.padding_left||$.padding_right||w.padding_top||w.padding_bottom||w.padding_left||w.padding_right?`${this.addPixelUnit($.padding_top||w.padding_top)||"0px"} ${this.addPixelUnit($.padding_right||w.padding_right)||"0px"} ${this.addPixelUnit($.padding_bottom||w.padding_bottom)||"0px"} ${this.addPixelUnit($.padding_left||w.padding_left)||"0px"}`:"0",margin:$.margin_top||$.margin_bottom||$.margin_left||$.margin_right||w.margin_top||w.margin_bottom||w.margin_left||w.margin_right?`${$.margin_top||w.margin_top||q} ${$.margin_right||w.margin_right||"0px"} ${$.margin_bottom||w.margin_bottom||q} ${$.margin_left||w.margin_left||"0px"}`:N},H.styles),{backdropFilter:$.backdrop_filter||w.backdrop_filter||"",border:$.border_style?`${$.border_width||"1px"} ${$.border_style} ${$.border_color||"var(--divider-color)"}`:this.getBorderCSS(w),borderRadius:this.addPixelUnit($.border_radius||w.border_radius)||"0",width:$.width||w.width||"100%",height:$.height||w.height||"",maxWidth:$.max_width||w.max_width||"",maxHeight:$.max_height||w.max_height||"",minWidth:$.min_width||w.min_width||"",minHeight:$.min_height||w.min_height||"",overflow:$.overflow||w.overflow||"",clipPath:$.clip_path||w.clip_path||"",position:$.position||w.position||"",top:$.top||w.top||"",right:$.right||w.right||"",bottom:$.bottom||w.bottom||"",left:$.left||w.left||"",zIndex:$.z_index||w.z_index||"",boxShadow:$.box_shadow_h||$.box_shadow_v||$.box_shadow_blur||$.box_shadow_spread||$.box_shadow_color?`${$.box_shadow_h||"0px"} ${$.box_shadow_v||"0px"} ${$.box_shadow_blur||"0px"} ${$.box_shadow_spread||"0px"} ${$.box_shadow_color||"rgba(0,0,0,0.2)"}`:"",boxSizing:"border-box",display:"block"});"line"===f.chart_type&&(B.padding="0"),"full"===f.chart_layout&&(B.margin="0",B.padding="0",B.borderRadius="0");const R=f.entities&&f.entities.length>0&&("forecast"===f.data_source?f.entities.some((t=>t.forecast_attribute)):f.entities.some((t=>t.entity)));if(!f.chart_type)return this.renderGradientErrorState("Select Chart Type","Choose a chart type in the General tab","mdi:chart-line");if(!R){const t="forecast"===f.data_source?"Configure forecast attributes in the General tab":"Add entities to display chart";return this.renderGradientErrorState("Configure Entities",t,"mdi:chart-line")}const G=f.entities.find((t=>t.is_primary&&t.entity))||f.entities.find((t=>t.entity)),J=G?e.states[G.entity]:void 0,V=f.title||(null==G?void 0:G.name)||(null===(m=null==J?void 0:J.attributes)||void 0===m?void 0:m.friendly_name)||"Chart Title",K=((null==G?void 0:G.attribute)?null===(_=null==J?void 0:J.attributes)||void 0===_?void 0:_.unit_of_measurement:null===(v=null==J?void 0:J.attributes)||void 0===v?void 0:v.unit_of_measurement)||"",Z=G?G.attribute?null===(b=null==J?void 0:J.attributes)||void 0===b?void 0:b[G.attribute]:null==J?void 0:J.state:void 0,Q="number"==typeof Z?Z:parseFloat(Z);let Y=this._prepareSimpleChartData(f,e,k,S,C);"forecast"===f.data_source&&this._historyData[f.id]&&(Y=this._historyData[f.id].datasets.map(((t,e)=>{let i;return i=k&&k[e]?this._formatColor(k[e]):S?this._formatColor(S):t.color,{name:t.name,value:t.values[t.values.length-1]||0,color:i,unit:t.unit,entityId:t.entityId}})));const X=f.info_position||"top_left",tt="full"===f.chart_layout,et="line"!==f.chart_type||!1===f.show_grid||!1===f.show_grid_values||tt?"16px":"32px",it={top_left:`top:12px; left:${et}; text-align:left;`,top_right:"top:12px; right:16px; text-align:right;",bottom_left:`bottom:12px; left:${et}; text-align:left;`,bottom_right:"bottom:12px; right:16px; text-align:right;",middle:"top:50%; left:50%; transform: translate(-50%, -50%); text-align:center;"},rt=(()=>{if(!G||!J)return"";try{const t=void 0!==Z?String(Z):J.state;return(0,y.formatEntityState)(e,G.entity,{state:t,includeUnit:!0})}catch(t){return`${isNaN(Q)?"":Q}${K?` ${K}`:""}`}})(),ot=!1!==f.show_display_name&&!1!==f.show_title,at=!1!==f.show_entity_value,nt=["pie","donut"].includes(f.chart_type)||!ot&&!at?r.qy``:r.qy`
          <div
        ...
        `,st=this._historyData[f.id],lt=!0===this._historyLoading[f.id]&&!st,dt=(this.getBackgroundImageCSS(Object.assign(Object.assign({},w),$),e),f.chart_alignment||"center"),ct="left"===dt?"flex-start":"right"===dt?"flex-end":"center",pt=this._resolveChartWidth(f),ht=r.qy`
      <div
    ...
    `,gt=null===(x=f.design)||void 0===x?void 0:x.hover_effect,ut=l.k.getHoverEffectClass(gt);return this.hasActiveLink(f)?r.qy`<div
          class="graphs-module-clickable ${ut}"
      ...
      >
        ...
        >
          ...
          ${""}
          ${f.map((e=>{const i=(e.startDeg+e.endDeg)/2,n=t=>t*Math.PI/180,s=m||v>0?v+.55*b:.55*u;let l=Math.cos(n(i))*s,d=Math.sin(n(i))*s;const c=.85*u;Math.abs(l)>c&&(l=Math.sign(l)*c),Math.abs(d)>c&&(d=Math.sign(d)*c);const p=e.endDeg-e.startDeg;let h=`${e.value}${e.unit||""}`;if(a&&e.entityId)try{h=(0,y.formatEntityState)(a,e.entityId,{state:e.value,includeUnit:!0})}catch(t){}const g=(t.entities||[]).find((t=>t&&t.entity===e.entityId)),_=(!g||!1!==g.label_show_name)&&p>=15,x=!g||!1!==g.label_show_value,f=p>=10,w=e.name.length>14?e.name.substring(0,14)+"...":e.name,$=h.length>10?h.substring(0,10)+"...":h;return f?r.JW`<g transform="translate(${l}, ${d})" style="pointer-events:none;">
              ${_?r.JW`<text 
                text-anchor="middle" 
    ...
    `}_renderLineChart(t,e,i,o,a,n,s){var l,d;const c=this._historyData[t.id];let p,h;this._historyError[t.id],this._historyLoading[t.id],c?(p=c.timePoints,h=c.datasets):(p=this._generateTimePoints(t.time_period),h=e.map(((e,i)=>{t.entities[i];const r=e.value||0,o=new Array(p.length).fill(r);return{name:e.name,color:e.color,values:o,lineWidth:e.lineWidth,showPoints:e.showPoints,fillArea:e.fillArea,lineStyle:e.lineStyle,unit:e.unit||"",entityId:e.entityId}}))),h=h.map(((e,i)=>{var r,o,l;const d=null===(r=t.entities)||void 0===r?void 0:r[i];let c;c=a&&a[i]?this._formatColor(a[i]):n?this._formatColor(n):this._formatColor(null==d?void 0:d.color)||e.color||this._getDefaultColor(i);const p=void 0!==s?s:!0===(null==d?void 0:d.fill_area)||e.fillArea;return Object.assign(Object.assign({},e),{color:c,lineWidth:null!==(l=null!==(o=null==d?void 0:d.line_width)&&void 0!==o?o:e.lineWidth)&&void 0!==l?l:2,showPoints:!1!==(null==d?void 0:d.show_points),fillArea:p,lineStyle:(null==d?void 0:d.line_style)||e.lineStyle||"solid"})}));let g,u,m=h;t.normalize_values&&(m=h.map((t=>{const e=Math.max(...t.values),i=Math.min(...t.values),r=e-i||1;return Object.assign(Object.assign({},t),{originalValues:t.values,values:t.values.map((t=>(t-i)/r*100)),normalizedMin:i,normalizedMax:e})}))),t.use_fixed_y_axis?(u=null!==(l=t.y_axis_min)&&void 0!==l?l:0,g=null!==(d=t.y_axis_max)&&void 0!==d?d:100,g<=u&&(g=u+1)):(g=Math.max(...m.flatMap((t=>t.values))),u=Math.min(...m.flatMap((t=>t.values))));const _=g-u,v=!1!==t.show_grid,b=!0===t.show_time_intervals,x=t;let f=(t.design||{}).background_color||x.background_color;f="transparent"===f?"var(--card-background-color)":f?this._formatColor(f):"var(--card-background-color, transparent)",Boolean(c&&"history"===c.source);const w="full"===t.chart_layout,$=!1!==t.show_grid_values&&v,k=w?2:$?28:10,S=w?2:5,C=w?2:12,z=300-k-S,T=100-C-(w?2:b?18:8),D=Math.max(1,Math.ceil(p.length/6));return r.qy`
      ...
      >
        <svg
          ...
          "
        >
          ${v?r.JW`${Array.from({length:4},((e,i)=>{const o=C+(i+1)/5*T,a=g-(i+1)/5*_,n=!1!==t.show_grid_values;return r.JW`
                  <line 
                    x1="${k}" 
                    y1="${o}" 
                    x2="${300-S}" 
                  ...
                  ${n?w?r.JW`
                          ...
                          >${Math.round(a)}</text>`:""}
                `}))}`:""}
          ${w&&v?r.JW`${p.map(((t,e)=>{if(e%D!=0&&e!==p.length-1)return r.JW``;const i=p.length>1?k+e/(p.length-1)*z:k+z/2;return r.JW`<line 
                  x1="${i}" y1="${C}" 
                  x2="${i}" y2="${C+T}" 
          ...
          ${(()=>m.map((e=>{var i;const a=e.values.map(((t,e)=>`${p.length>1?k+e/(p.length-1)*z:k+z/2},${_>0?C+(g-t)/_*T:C+T/2}`)),n=(e=>{if(!t.smooth_curves)return e.map(((t,e)=>{const[i,r]=t.split(",");return`${0===e?"M":"L"} ${i} ${r}`})).join(" ");if(e.length<2){const[t,i]=e[0].split(",");return`M ${t} ${i}`}let i="";const r=e.map((t=>{const[e,i]=t.split(",");return{x:parseFloat(e),y:parseFloat(i)}}));i=`M ${r[0].x} ${r[0].y}`;for(let t=0;t<r.length-1;t++){const e=r[Math.max(0,t-1)],o=r[t],a=r[t+1],n=r[Math.min(r.length-1,t+2)],s=.5;i+=` C ${o.x+(a.x-e.x)/6*s} ${o.y+(a.y-e.y)/6*s}, ${a.x-(n.x-o.x)/6*s} ${a.y-(n.y-o.y)/6*s}, ${a.x} ${a.y}`}return i})(a),s=a[a.length-1].split(",")[0],l=a[0].split(",")[0],d=this._colorWithAlpha(e.color,.25),c="dashed"===e.lineStyle?"4 3":"dotted"===e.lineStyle?"1 3":"none",u=C+T;return r.JW`<g>
                ...
                ${!1!==e.showPoints?r.JW`${e.values.map(((i,a)=>{const n=p.length>1?k+a/(p.length-1)*z:k+z/2,s=_>0?C+(g-i)/_*T:C+T/2,l="transparent"===f?"var(--card-background-color)":f,d=`point-${t.id}-${a}-${h.indexOf(e)}`;return r.JW`
                          <circle 
                            id="${d}"
                            cx="${n}" 
                            cy="${s}" 
                            ...
                            @mouseenter=${!1!==t.show_tooltips?r=>{const n=e.originalValues?e.originalValues[a]:i;let s=`${n}${e.unit||""}`;e.entityId&&(s=(0,y.formatEntityState)(o,e.entityId,{state:n,includeUnit:!0})),this._showTooltip(r,t.id,e.name,s,p[a])}:null}
          ...
          ${b?r.JW`${p.map(((t,e)=>{if(e%D!=0&&e!==p.length-1)return r.JW``;const i=p.length>1?k+e/(p.length-1)*z:k+z/2;if(w){const e=C+T-3,o=4*t.length+4;return r.JW`
                    ...
                    <text
                      ...
                      opacity="0.85"
                      text-anchor="middle"
                    >${t}</text>`}const o=C+T+10;return r.JW`<text
                  x="${i}"
                  y="${o}"
                  font-size="7"
                  fill="var(--secondary-text-color)"
                ...
                >
                  ...
                  >
                    <div
                      ...
                      "
                    ></div>
                    ${M.map(((n,s)=>{var l;const d=null!==(l=n.values[i])&&void 0!==l?l:0,c=t.normalize_values&&n.originalValues?n.originalValues[i]:n.values[i],p=n.entityId;let h=`${null!=c?c:0}${n.unit||""}`;if(a&&void 0!==p&&void 0!==c)try{h=(0,y.formatEntityState)(a,p,{state:c,includeUnit:!0})}catch(t){}const g=I/b,u=v>=0?I:_<=0?0:_*g,m=_===v?u:(_-d)*g,x=Math.min(u,m),f=Math.abs(u-m),w=Math.max(2,Math.min(f,I)),$=.55*S*(s-(k-1)/2),C=1===k;return r.qy`
                        <div
                          class="bar-segment"
                          style="
                            position:absolute;
