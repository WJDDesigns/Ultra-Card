"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[6653],{8032:(e,t,i)=>{i.r(t),i.d(t,{UltraNativeCardModule:()=>C,cleanupNativeCardCache:()=>y});var n=i(5183),o=i(8791),a=i(7475),r=i(1874),c=i(1001),s=i(382);const d=new Map,l=new Map,p=new Map,g=new Map,f=new Map,v=new Map;class C extends a.m{constructor(){super(...arguments),this.metadata={type:"native_card",title:"Native HA Card",description:"Native Home Assistant card",author:"Home Assistant",version:"1.0.0",icon:"mdi:home-assistant",category:"content",tags:["native","home-assistant","card"]}}createDefault(){return{id:`native-card-${Date.now()}`,type:"native_card",name:"Native Card",card_type:"hui-entities-card",card_config:{type:"entities",entities:[]},display_conditions:[]}}_attachContainerEventListeners(e){if(e.hasAttribute("data-uc-events-attached"))return;e.setAttribute("data-uc-events-attached","true");const t=e=>{e.stopPropagation()};e.addEventListener("keydown",t,!1),e.addEventListener("keyup",t,!1),e.addEventListener("keypress",t,!1),e.addEventListener("input",t,!1),e.addEventListener("change",t,!1),e.addEventListener("focus",t,!1),e.addEventListener("blur",t,!1),e.addEventListener("click",t,!1),e.addEventListener("mousedown",t,!1),e.addEventListener("mouseup",t,!1),e.addEventListener("pointerdown",t,!1),e.addEventListener("pointerup",t,!1)}renderGeneralTab(e,t,i,a){const c=r.e.getNativeCardInfo(e.card_type),s=(null==c?void 0:c.name)||e.name||"Native Card";return n.qy`
