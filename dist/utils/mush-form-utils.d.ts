...
/**
 * Mushroom-style form utilities
 * Clean form rendering without CSS label hiding hacks
 */
export declare class MushFormUtils {
    /**
     * Mushroom-style form renderer with computeLabel control
     */
    ...
    /**
     * Get clean form styles (much simpler than FormUtils)
     */
