...
export declare class UltraVehicleCard extends LitElement {
    ...
    private _renderModularLayout;
    private _renderModularRow;
    private _getColumnWidths;
    private _renderModularColumn;
    private _renderModularModule;
    private _renderImageModule;
    private _renderInfoModule;
    private _renderBarModule;
    private _renderIconModule;
    private _renderTextModule;
    private _renderSeparatorModule;
