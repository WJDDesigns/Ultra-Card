<?php
/**
 * FINAL FIXED Directories Pro Integration for Ultra Card
 * Title: Directories Pro Ultra Card Integration with Fixed Descriptions & CORS
 */
    ...
    register_rest_field('presets_dir_ltg', 'preset_meta', array(
        'get_callback' => function($post) {
            ...
            return array(
                ...
                'gallery' => array(),
                'description' => $description ?: 'No description available', // Now properly extracted!
            );
        }
    ));
}
