...
define('ULTRA_CARD_INTEGRATION_VERSION', '1.3.59');
...
// Theme catalog: ultra_theme CPT, ultra-card/v1/themes catalog + authoring API.
$uc_theme_authoring = ULTRA_CARD_INTEGRATION_PLUGIN_DIR . 'includes/uc-theme-authoring.php';
if (file_exists($uc_theme_authoring)) {
    require_once $uc_theme_authoring;
}
        ...
        <div class="ucp-membership-panel">
            ...
            <?php else: ?>
                ...
                <div class="ucp-membership-header">
                    ...
                    <p><?php
                        if ($is_lifetime) {
                            echo 'Thank you for being a Lifetime member. Pro is yours for the life of Ultra Card.';
                        } elseif ($subscription_data['tier'] === 'pro') {
