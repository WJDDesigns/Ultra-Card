"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[6001],{4442:(e,n,t)=>{t.r(n),t.d(n,{UltraVerticalModule:()=>m});var i=t(5183),o=t(1043),a=t(7475),r=t(6990),l=t(5255),d=t(8938),s=t(6478),c=t(230),p=t(378),g=t(361),u=t(6477);class m extends a.m{constructor(){super(...arguments),this.metadata={type:"vertical",title:"Vertical Layout",description:"Arrange modules in columns with flexible alignment and spacing",author:"WJD Designs",version:"1.0.0",icon:"mdi:view-agenda",category:"layout",tags:["layout","vertical","alignment","container","flexbox"]}}createDefault(e,n){return{id:e||this.generateId("vertical"),type:"vertical",alignment:"center",horizontal_alignment:"stretch",gap:1.2,modules:[],tap_action:{action:"nothing"},hold_action:{action:"nothing"},double_tap_action:{action:"nothing"},display_mode:"always",display_conditions:[]}}renderGeneralTab(e,n,t,o){var a;const r=e,l=(null===(a=null==n?void 0:n.locale)||void 0===a?void 0:a.language)||"en";return i.qy`
      ${this.injectUcFormStyles()}

      <div class="module-general-settings">
        <!-- Layout Configuration Section -->
        ${this.renderSettingsSection((0,s.kg)("editor.vertical.layout.title",l,"Layout Configuration"),(0,s.kg)("editor.vertical.layout.desc",l,"Configure alignment and spacing for items in a single column."),[{title:(0,s.kg)("editor.vertical.alignment.horizontal",l,"Horizontal Alignment"),description:(0,s.kg)("editor.vertical.alignment.horizontal_desc",l,"Choose how items are aligned horizontally within the column."),hass:n,data:{horizontal_alignment:r.horizontal_alignment||"center"},schema:[this.selectField("horizontal_alignment",[{value:"left",label:(0,s.kg)("editor.common.left",l,"Left")},{value:"center",label:(0,s.kg)("editor.common.center",l,"Center")},{value:"right",label:(0,s.kg)("editor.common.right",l,"Right")},{value:"stretch",label:(0,s.kg)("editor.common.stretch",l,"Stretch")}])],onChange:e=>{e.detail.value.horizontal_alignment!==(r.horizontal_alignment||"center")&&(o(e.detail.value),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}},{title:(0,s.kg)("editor.vertical.alignment.vertical",l,"Vertical Distribution"),description:(0,s.kg)("editor.vertical.alignment.vertical_desc",l,"How items are distributed along the vertical axis."),hass:n,data:{alignment:r.alignment||"top"},schema:[this.selectField("alignment",[{value:"top",label:(0,s.kg)("editor.common.top",l,"Top")},{value:"center",label:(0,s.kg)("editor.common.center",l,"Center")},{value:"bottom",label:(0,s.kg)("editor.common.bottom",l,"Bottom")},{value:"space-between",label:(0,s.kg)("editor.common.space_between",l,"Space Between")},{value:"space-around",label:(0,s.kg)("editor.common.space_around",l,"Space Around")}])],onChange:e=>{e.detail.value.alignment!==(r.alignment||"top")&&(o(e.detail.value),setTimeout((()=>{this.triggerPreviewUpdate()}),50))}}])}
        ...
        >
          ...
          <div style="margin-bottom: 8px;">
            ...
            >
              ${(0,s.kg)("editor.vertical.gap.between_items",l,"Gap Between Items")}
            </div>
            <div
              class="field-description"
              style="font-size: 13px; color: var(--secondary-text-color); margin-bottom: 12px; opacity: 0.8; line-height: 1.4;"
            >
              ${(0,s.kg)("editor.vertical.gap.desc",l,"Set the spacing between vertical items (in rem units). Use negative values to overlap items. Any value is allowed. Note: Gap is disabled when using Space Between or Space Around distribution.")}
            </div>
            <div
    ...
    `}renderPreview(e,n,t,a){var r,l,d,p;const m=e;this._currentConfig=t,this._currentPreviewContext=a;const v=(null===(r=null==n?void 0:n.locale)||void 0===r?void 0:r.language)||"en",h=m,b=Object.assign(Object.assign({},h),h.design||{}),_=m.modules&&m.modules.length>0,x=void 0!==m.gap?m.gap:1.2,y=(0,u.U9)({color:b.background_color,fallback:"transparent",image:this.getBackgroundImageCSS(b,n),imageSize:b.background_size||"cover",imagePosition:b.background_position||"center",imageRepeat:b.background_repeat||"no-repeat"}),w=b.border_radius||h.border_radius||(void 0!==(null===(l=b.border)||void 0===l?void 0:l.radius)?b.border.radius:void 0)||(void 0!==(null===(d=h.border)||void 0===d?void 0:d.radius)?h.border.radius:void 0),f=Object.assign(Object.assign({padding:this.getPaddingCSS(b),margin:this.getMarginCSS(b)},y.styles),{border:b.border_width||b.border_color||b.border_style&&"none"!==b.border_style?this.getBorderCSS(b):"none",borderRadius:this.addPixelUnit(w)||"0",position:b.position||(b.z_index?"relative":"static"),zIndex:b.z_index||"auto",width:b.width||void 0,height:b.height||void 0,maxWidth:b.max_width||void 0,minWidth:b.min_width||void 0,maxHeight:b.max_height||void 0,boxShadow:b.box_shadow||void 0,backdropFilter:b.backdrop_filter||void 0,clipPath:b.clip_path||void 0,display:"flex",flexDirection:"column",justifyContent:this.getJustifyContent(m.alignment||"center"),gap:x>=0&&"space-between"!==m.alignment&&"space-around"!==m.alignment?`${x}rem`:"0",alignItems:this.getAlignItems(m.horizontal_alignment||"center"),minHeight:b.min_height||"auto",overflow:(()=>{const e=b.overflow;return e&&"visible"!==e?e:w&&"0"!==String(w)&&"0px"!==String(w)?"hidden":e||"visible"})(),boxSizing:"border-box"}),k=this.createGestureHandlers(m.id,{tap_action:m.tap_action,hold_action:m.hold_action,double_tap_action:m.double_tap_action,entity:m.entity,module:m},n,t),$=null===(p=m.design)||void 0===p?void 0:p.css_variable_prefix;if($){const e=(0,g.E)($,m.design);Object.assign(f,e)}const S=m.tap_action&&"nothing"!==m.tap_action.action||m.hold_action&&"nothing"!==m.hold_action.action||m.double_tap_action&&"nothing"!==m.double_tap_action.action;return i.qy`
      <div class="vertical-module-preview">
        <div
          class="vertical-preview-content"
          style="${this.styleObjectToCss(f)}; cursor: ${S?"pointer":"default"}; ${S?"pointer-events: auto;":""}"
          @pointerdown=${S?k.onPointerDown:null}
          @pointerup=${S?k.onPointerUp:null}
          @pointercancel=${S?k.onPointerCancel:null}
          @pointerleave=${S?k.onPointerLeave:null}
        >
          ${_?(()=>{c.S.setHass(n);const e=m.modules.filter((e=>{var n,t,i,o;const a=e,r=c.S.evaluateModuleVisibility(a),l=c.S.evaluateLogicProperties({logic_entity:null===(n=null==a?void 0:a.design)||void 0===n?void 0:n.logic_entity,logic_attribute:null===(t=null==a?void 0:a.design)||void 0===t?void 0:t.logic_attribute,logic_operator:null===(i=null==a?void 0:a.design)||void 0===i?void 0:i.logic_operator,logic_value:null===(o=null==a?void 0:a.design)||void 0===o?void 0:o.logic_value});return r&&l}));return(0,o.u)(e,(e=>e.id||e.type),((e,t)=>{const o=x<0&&t>0&&"space-between"!==m.alignment&&"space-around"!==m.alignment,a=o?`${x}rem 0 0 0`:"0",r=o;return i.qy`
                      <div
                      ...
                      >
                        ${this._renderChildModulePreview(e,n,h,this._currentConfig,this._currentPreviewContext)}
                      </div>
                    `}))})():i.qy`
                <div class="empty-layout-message">
                  <span
                    >${(0,s.kg)("editor.vertical.empty.no_modules",v,"No modules added yet")}</span
                  >
                  <small
                    >${(0,s.kg)("editor.vertical.empty.add_modules",v,"Add modules in the layout builder to see them here")}</small
                  >
                </div>
              `}
        </div>
      </div>
    `}_renderChildModulePreview(e,n,t,o,a){var r,d,s,g,u,m,v,h,b,_,x,y,w,f,k,$,S,z,C,P;let U=e;t&&(U=this.applyLayoutDesignToChild(e,t)),c.S.setHass(n);const j=U,A=c.S.evaluateModuleVisibility(j),L=c.S.evaluateLogicProperties({logic_entity:null===(r=null==j?void 0:j.design)||void 0===r?void 0:r.logic_entity,logic_attribute:null===(d=null==j?void 0:j.design)||void 0===d?void 0:d.logic_attribute,logic_operator:null===(s=null==j?void 0:j.design)||void 0===s?void 0:s.logic_operator,logic_value:null===(g=null==j?void 0:j.design)||void 0===g?void 0:g.logic_value});if(!A||!L)return i.qy``;const B=(0,l.oD)().getModule(U.type);if(!B)return i.qy``;const I=(null===(m=null===(u=B.metadata)||void 0===u?void 0:u.tags)||void 0===m?void 0:m.includes("pro"))||(null===(h=null===(v=B.metadata)||void 0===v?void 0:v.tags)||void 0===h?void 0:h.includes("premium"))||!1;let M=!1;const D=p.x.checkIntegrationAuth(n);if("pro"===(null===(b=null==D?void 0:D.subscription)||void 0===b?void 0:b.tier)&&"active"===(null===(_=null==D?void 0:D.subscription)||void 0===_?void 0:_.status))M=!0;else if(p.x.isAuthenticated()){const e=p.x.getCurrentUser();"pro"===(null===(x=null==e?void 0:e.subscription)||void 0===x?void 0:x.tier)&&"active"===(null===(y=null==e?void 0:e.subscription)||void 0===y?void 0:y.status)&&(M=!0)}const T=I&&!M;if(B){const e=B.renderPreview(U,n,o,a);if(T)return i.qy`
