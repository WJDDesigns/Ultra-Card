"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[525],{5776:(e,t,i)=>{i.r(t),i.d(t,{UltraDynamicWeatherModule:()=>l});var r=i(5183),a=i(7475),o=i(8938),n=i(378),d=i(1713),s=i(6478);class l extends a.m{constructor(){super(...arguments),this.metadata={type:"dynamic_weather",title:"Dynamic Weather",description:"Add animated weather effects (rain, snow, fog, sun beams) to your dashboard view.",author:"WJD Designs",version:"1.0.0",icon:"mdi:weather-partly-rainy",category:"media",tags:["weather","effects","pro","premium","animated","rain","snow","fog"]}}createDefault(e,t){const i=this._findWeatherEntity(t);return{id:e||this.generateId("dynamic_weather"),type:"dynamic_weather",enabled:!0,mode:"automatic",weather_entity:i,manual_effect:"rain",position:"background",opacity:50,matrix_rain_color:"#00ff00",enable_on_mobile:!0,respect_reduced_motion:!0,display_mode:"always",display_conditions:[]}}_findWeatherEntity(e){if(!e)return"";const t=Object.keys(e.states).filter((e=>e.startsWith("weather.")));return t.length>0?t[0]:""}renderGeneralTab(e,t,i,a){var o,s,l,c,p;const u=e,m=(null===(o=null==t?void 0:t.locale)||void 0===o?void 0:o.language)||"en",g=n.x.checkIntegrationAuth(t);return"pro"===(null===(s=null==g?void 0:g.subscription)||void 0===s?void 0:s.tier)&&"active"===(null===(l=null==g?void 0:g.subscription)||void 0===l?void 0:l.status)?r.qy`
