# Directories Pro Migration Guide

## Changes Needed in Ultra Card Code

### 1. Update src/services/uc-presets-service.ts
...
**Line ~220 - Update API call in \_loadWordPressPresets method:**
...
**Line ~143 - Update download tracking:**
...
### 2. WordPress Code Snippet for Directories Pro

Replace your current WordPress snippet with:
...
- Replace your current snippet with the Directories Pro version above
- **Uncomment the force save line** to save your shortcode
- **Run it once, then comment it back out**

### 2. **Update Ultra Card Code**

You need to make these 3 small changes in `src/services/uc-presets-service.ts`:

- Change the import to use `directories-pro-presets-api`
- Update the API calls to use `directoriesProPresetsAPI`

### 3. **Test**

After both updates, your preset should work perfectly with Directories Pro!

**Would you like me to help you make the Ultra Card code changes, or do you want to handle that?**
