"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[5115],{4512:(e,n,t)=>{t.r(n),t.d(n,{UltraHorizontalModule:()=>m});var i=t(5183),o=t(1043),a=t(7475),r=t(6990),l=t(5255),d=t(5262),s=t(8938),c=t(6478),u=t(230),p=t(378),g=t(361),h=t(6477);class m extends a.m{constructor(){super(...arguments),this.metadata={type:"horizontal",title:"Horizontal Layout",description:"Arrange modules in rows with flexible horizontal and vertical alignment and spacing",author:"WJD Designs",version:"1.0.0",icon:"mdi:view-column",category:"layout",tags:["layout","horizontal","vertical","alignment","container","flexbox"]}}createDefault(e,n){return{id:e||this.generateId("horizontal"),type:"horizontal",alignment:"center",vertical_alignment:void 0,gap:.7,wrap:!1,modules:[],tap_action:{action:"nothing"},hold_action:{action:"nothing"},double_tap_action:{action:"nothing"},display_mode:"always",display_conditions:[]}}renderGeneralTab(e,n,t,o){var a;const r=e,l=(null===(a=null==n?void 0:n.locale)||void 0===a?void 0:a.language)||"en";return i.qy`
      ${this.injectUcFormStyles()}

      <div class="module-general-settings">
        <!-- Layout Configuration Section -->
        ${this.renderSettingsSection((0,c.kg)("editor.horizontal.layout.title",l,"Layout Configuration"),(0,c.kg)("editor.horizontal.layout.desc",l,"Configure how items are arranged horizontally within the container."),[{title:(0,c.kg)("editor.horizontal.alignment.horizontal",l,"Horizontal Alignment"),description:(0,c.kg)("editor.horizontal.alignment.horizontal_desc",l,"Choose how items are aligned horizontally within the container."),hass:n,data:r,schema:[this.selectField("alignment",[{value:"left",label:(0,c.kg)("editor.common.left",l,"Left")},{value:"center",label:(0,c.kg)("editor.common.center",l,"Center")},{value:"right",label:(0,c.kg)("editor.common.right",l,"Right")},{value:"space-between",label:(0,c.kg)("editor.common.space_between",l,"Space Between")},{value:"space-around",label:(0,c.kg)("editor.common.space_around",l,"Space Around")},{value:"justify",label:(0,c.kg)("editor.common.justify",l,"Justify")}])],onChange:e=>{e.detail.value.alignment!==r.alignment&&o(e.detail.value)}}])}
        ${this.renderSettingsSection("","",[{title:(0,c.kg)("editor.horizontal.alignment.vertical",l,"Vertical Alignment"),description:(0,c.kg)("editor.horizontal.alignment.vertical_desc",l,"Choose how items are aligned vertically within the container."),hass:n,data:r,schema:[this.selectField("vertical_alignment",[{value:"top",label:(0,c.kg)("editor.common.top",l,"Top")},{value:"center",label:(0,c.kg)("editor.common.center",l,"Center")},{value:"bottom",label:(0,c.kg)("editor.common.bottom",l,"Bottom")},{value:"stretch",label:(0,c.kg)("editor.common.stretch",l,"Stretch")},{value:"baseline",label:(0,c.kg)("editor.common.baseline",l,"Baseline")}])],onChange:e=>{var n;const t=null===(n=e.detail.value)||void 0===n?void 0:n.vertical_alignment;void 0!==t&&t!==r.vertical_alignment&&o({vertical_alignment:t})}}])}
        ...
        >
          ...
          <div style="margin-bottom: 24px;">
            ...
            >
              ${(0,c.kg)("editor.horizontal.gap.desc",l,"Set the spacing between horizontal items (in rem units). Use negative values to overlap items. Any value is allowed.")}
            </div>
            <div
    ...
    `}renderPreview(e,n,t,a){var r,l,s,p,m;const v=e;this._currentConfig=t,this._currentPreviewContext=a;const b=(null===(r=null==n?void 0:n.locale)||void 0===r?void 0:r.language)||"en",_=v,x=Object.assign(Object.assign({},_),_.design||{}),w=v.modules&&v.modules.length>0,f=void 0!==v.gap?v.gap:.7,y=v.alignment,k=void 0!==x.width&&null!==x.width&&""!==x.width?x.width:void 0,z=this.getMarginCSS(x),$=(0,h.U9)({color:x.background_color,fallback:"transparent",image:this.getBackgroundImageCSS(x,n),imageSize:x.background_size||"cover",imagePosition:x.background_position||"center",imageRepeat:x.background_repeat||"no-repeat"}),S=x.border_radius||_.border_radius||(void 0!==(null===(l=x.border)||void 0===l?void 0:l.radius)?x.border.radius:void 0)||(void 0!==(null===(s=_.border)||void 0===s?void 0:s.radius)?_.border.radius:void 0),C=Object.assign(Object.assign({padding:this.getPaddingCSS(x)},$.styles),{border:x.border_width?this.getBorderCSS(x):"none",borderRadius:this.addPixelUnit(S)||"0",position:x.position||(x.z_index?"relative":"static"),zIndex:x.z_index||"auto",width:k,height:x.height||void 0,maxWidth:x.max_width||void 0,minWidth:x.min_width||void 0,maxHeight:x.max_height||void 0,boxShadow:x.box_shadow||void 0,backdropFilter:x.backdrop_filter||void 0,clipPath:x.clip_path||void 0,display:"flex",flexDirection:"row",justifyContent:y?this.getJustifyContent(y):void 0,gap:f>=0?`${f}rem`:"0",flexWrap:v.wrap?"wrap":"nowrap",alignItems:v.vertical_alignment?this.getAlignItems(v.vertical_alignment):void 0,minHeight:x.min_height||"auto",overflow:(()=>{const e=x.overflow;return e&&"visible"!==e?e:S&&"0"!==String(S)&&"0px"!==String(S)?"hidden":e||"visible"})(),boxSizing:"border-box"});void 0!==z&&"0"!==z&&(C.margin=z);const P=this.createGestureHandlers(v.id,{tap_action:v.tap_action,hold_action:v.hold_action,double_tap_action:v.double_tap_action,entity:v.entity,module:v},n,t),j=null===(p=v.design)||void 0===p?void 0:p.hover_effect,A=d.k.getHoverEffectClass(j),M=null===(m=v.design)||void 0===m?void 0:m.css_variable_prefix;if(M){const e=(0,g.E)(M,v.design);Object.assign(C,e)}const U=v.tap_action&&"nothing"!==v.tap_action.action||v.hold_action&&"nothing"!==v.hold_action.action||v.double_tap_action&&"nothing"!==v.double_tap_action.action;return i.qy`
      <style>
        ${this.getStyles()}
      </style>
      <div
      ...
      >
        <div
          class="horizontal-preview-content ${A}"
          style="${this.styleObjectToCss(C)}; cursor: ${U?"pointer":"default"}; ${U?"pointer-events: auto;":""}"
          data-wrap=${v.wrap?"true":"false"}
          @pointerdown=${U?P.onPointerDown:null}
          @pointerup=${U?P.onPointerUp:null}
          @pointercancel=${U?P.onPointerCancel:null}
          @pointerleave=${U?P.onPointerLeave:null}
        >
          ${w?(()=>{u.S.setHass(n);const e=v.modules.filter((e=>{var n,t,i,o;const a=e,r=u.S.evaluateModuleVisibility(a),l=u.S.evaluateLogicProperties({logic_entity:null===(n=null==a?void 0:a.design)||void 0===n?void 0:n.logic_entity,logic_attribute:null===(t=null==a?void 0:a.design)||void 0===t?void 0:t.logic_attribute,logic_operator:null===(i=null==a?void 0:a.design)||void 0===i?void 0:i.logic_operator,logic_value:null===(o=null==a?void 0:a.design)||void 0===o?void 0:o.logic_value});return r&&l}));return(0,o.u)(e,(e=>e.id||e.type),((e,t)=>{const o=f<0&&t>0?`0 0 0 ${f}rem`:"0",a=f<0,r="justify"===v.alignment,l=this.childShouldFillAvailableSpace(e),d=r||l?null:this.getChildPreferredWidth(e),s=`\n                      overflow: visible;\n                      ${[r?"flex-grow: 1; flex-shrink: 1; flex-basis: 0;":"",l?"flex-grow: 1; flex-shrink: 1; flex-basis: auto; min-width: 10%;":"",r||l||!d?"":`flex: 0 0 ${d}; max-width: ${d}; width: ${d};`].filter(Boolean).join(" ")}\n                      box-sizing: border-box;\n                      margin: ${o};\n                    `,c=a?"padding: 0; border: none; background: transparent;":"";return i.qy`
                      <div
                        class="child-module-preview ${a?"negative-gap":""}"
                        data-flex-constrained="${d?"true":"false"}"
                        style="${s} ${c}"
                      >
                        ${this._renderChildModulePreview(e,n,_,this._currentConfig,this._currentPreviewContext)}
                      </div>
                    `}))})():i.qy`
                <div class="empty-layout-message">
                  <span
                    >${(0,c.kg)("editor.horizontal.empty.no_modules",b,"No modules added yet")}</span
                  >
                  <small
                    >${(0,c.kg)("editor.horizontal.empty.add_modules",b,"Add modules in the layout builder to see them here")}</small
                  >
                </div>
              `}
        </div>
      </div>
    `}_renderChildModulePreview(e,n,t,o,a){var r,d,s,c,g,h,m,v,b,_,x,w,f,y,k,z,$,S,C,P;let j=e;t&&(j=this.applyLayoutDesignToChild(e,t));const A=t;if(A&&A.alignment){const e=j;e.alignment||(e.alignment=A.alignment)}u.S.setHass(n);const M=j,U=u.S.evaluateModuleVisibility(M),L=u.S.evaluateLogicProperties({logic_entity:null===(r=null==M?void 0:M.design)||void 0===r?void 0:r.logic_entity,logic_attribute:null===(d=null==M?void 0:M.design)||void 0===d?void 0:d.logic_attribute,logic_operator:null===(s=null==M?void 0:M.design)||void 0===s?void 0:s.logic_operator,logic_value:null===(c=null==M?void 0:M.design)||void 0===c?void 0:c.logic_value});if(!U||!L)return i.qy``;const W=(0,l.oD)().getModule(j.type);if(!W)return i.qy``;const B=(null===(h=null===(g=W.metadata)||void 0===g?void 0:g.tags)||void 0===h?void 0:h.includes("pro"))||(null===(v=null===(m=W.metadata)||void 0===m?void 0:m.tags)||void 0===v?void 0:v.includes("premium"))||!1;let V=!1;const F=p.x.checkIntegrationAuth(n);if("pro"===(null===(b=null==F?void 0:F.subscription)||void 0===b?void 0:b.tier)&&"active"===(null===(_=null==F?void 0:F.subscription)||void 0===_?void 0:_.status))V=!0;else if(p.x.isAuthenticated()){const e=p.x.getCurrentUser();"pro"===(null===(x=null==e?void 0:e.subscription)||void 0===x?void 0:x.tier)&&"active"===(null===(w=null==e?void 0:e.subscription)||void 0===w?void 0:w.status)&&(V=!0)}const I=B&&!V;if(W){const e=W.renderPreview(j,n,o,a);if(I)return i.qy`
