"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[9983],{602:(e,t,o)=>{o.r(t),o.d(t,{UltraDynamicListModule:()=>j});var i=o(5183),n=o(7475),a=o(5147),s=o(8938),l=o(5320);const r="__uvc_todo_cache";class d{constructor(){this._unsubByEntity=new Map,this._callbacksByEntity=new Map}async getItems(e,t,o){if(!e||!t)return[];e[r]||(e[r]=Object.create(null));const i=e[r],n=()=>{if(o){let e=this._callbacksByEntity.get(t);e||(e=new Set,this._callbacksByEntity.set(t,e)),e.add(o)}},a=()=>{const e=this._callbacksByEntity.get(t);e&&e.forEach((e=>{try{e()}catch(e){}}))},s=async()=>{var o;try{const n=await e.callService("todo","get_items",{entity_id:t},void 0,!0,!0),a=null!==(o=null==n?void 0:n.response)&&void 0!==o?o:{};let s=[];const l=a[t];if(Array.isArray(null==l?void 0:l.items))s=l.items;else if(Array.isArray(null==l?void 0:l.todo_items))s=l.todo_items;else if(Array.isArray(l))s=l;else if(Array.isArray(a))s=a;else if("object"==typeof a&&null!==a){const e=Object.keys(a).find((e=>e.startsWith("todo."))),t=e?a[e]:void 0;Array.isArray(null==t?void 0:t.items)?s=t.items:Array.isArray(null==t?void 0:t.todo_items)?s=t.todo_items:Array.isArray(t)&&(s=t)}return 0===s.length&&(l||a&&Object.keys(a).length>0)&&console.warn("[UltraCard] todo.get_items: unexpected response shape",{entityId:t,responseKeys:Object.keys(a),entry:l?Object.keys(l):null}),i[t]=s,s}catch(e){return console.warn("[UltraCard] todo.get_items failed for",t,e),i[t]=[],[]}};if(void 0!==i[t])return n(),this._ensureSubscription(e,t,s,a),i[t];const l=await s();return n(),this._ensureSubscription(e,t,s,a),l}_ensureSubscription(e,t,o,i){if(this._unsubByEntity.has(t))return;const n=e.connection;(null==n?void 0:n.subscribeEvents)&&n.subscribeEvents((e=>{var n;(null===(n=null==e?void 0:e.data)||void 0===n?void 0:n.entity_id)===t&&o().then((()=>i()))}),"state_changed").then((e=>{this._unsubByEntity.set(t,e)})).catch((()=>{}))}unsubscribeEntity(e){const t=this._unsubByEntity.get(e);if(t){try{t()}catch(e){}this._unsubByEntity.delete(e)}this._callbacksByEntity.delete(e)}}var c=o(5155),m=o(5255),p=o(230),u=o(378),v=o(6478);o(9442),o(7921);const y="{# Todo Template — full control over how each item renders.\n   Available variables:\n     items   — list of todo item objects with keys:\n                 summary, status, due, description, uid, entity_id\n   Output a JSON array of module configs via | tojson. #}\n{% set ns = namespace(mods=[]) %}\n{% for item in items %}\n  {% set is_done = item.status == 'completed' %}\n  {% set color = '#9e9e9e' if is_done else 'var(--primary-text-color)' %}\n  {% set icon  = 'mdi:checkbox-marked-circle' if is_done else 'mdi:checkbox-blank-circle-outline' %}\n  {% set label = item.summary ~ (' ✓' if is_done else '') %}\n  {% set label = label ~ (' — ' ~ item.due if item.due else '') %}\n  {% set mod = {\n    'id': 'todo_tpl_' ~ loop.index,\n    'type': 'text',\n    'text': label,\n    'color': color,\n    'icon': icon,\n    'icon_position': 'before',\n    'display_mode': 'always', 'display_conditions': []\n  } %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",h="{# Action Template — build modules from a HA service response.\n   'response' holds the raw return value of your configured action.\n   For todo.get_items with entity_id 'todo.shopping' the structure is:\n     response['todo.shopping']['items']  — list of items\n\n   Adapt the path below to match your own service response shape. #}\n{% set entity = 'todo.shopping' %}\n{% set raw = response.get(entity, {}).get('items', []) %}\n{% set ns = namespace(mods=[]) %}\n{% for item in raw %}\n  {% set is_done = item.status == 'completed' %}\n  {% set mod = {\n    'id': 'act_' ~ loop.index,\n    'type': 'text',\n    'text': item.summary ~ (' ✓' if is_done else ''),\n    'color': '#4caf50' if is_done else 'var(--primary-text-color)',\n    'display_mode': 'always', 'display_conditions': []\n  } %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",_="{# Doors & Windows — shows open/closed with color-coded icon #}\n{% set sensors = [\n  {'entity': 'binary_sensor.front_door',        'name': 'Front Door',        'icon_on': 'mdi:door-open',    'icon_off': 'mdi:door-closed'},\n  {'entity': 'binary_sensor.back_door',         'name': 'Back Door',         'icon_on': 'mdi:door-open',    'icon_off': 'mdi:door-closed'},\n  {'entity': 'binary_sensor.garage_door',       'name': 'Garage',            'icon_on': 'mdi:garage-open',  'icon_off': 'mdi:garage'},\n  {'entity': 'binary_sensor.living_room_window','name': 'Living Room Window','icon_on': 'mdi:window-open',  'icon_off': 'mdi:window-closed'},\n  {'entity': 'binary_sensor.bedroom_window',   'name': 'Bedroom Window',    'icon_on': 'mdi:window-open',  'icon_off': 'mdi:window-closed'}\n] %}\n{% set ns = namespace(mods=[]) %}\n{% for s in sensors %}\n  {% set is_open = states(s.entity) == 'on' %}\n  {% set icon_item = {\n    'id': 'ii_' ~ loop.index,\n    'icon_mode': 'entity',\n    'entity': s.entity,\n    'name': s.name,\n    'icon_inactive': s.icon_off,\n    'icon_active':   s.icon_on,\n    'active_state':  'on',\n    'inactive_icon_color': '#4caf50',\n    'active_icon_color':   '#f44336',\n    'show_name_when_inactive': true, 'show_state_when_inactive': true, 'show_icon_when_inactive': true,\n    'show_name_when_active':   true, 'show_state_when_active':   true, 'show_icon_when_active':   true\n  } %}\n  {% set mod = {'id': 'dw_' ~ loop.index, 'type': 'icon', 'icons': [icon_item], 'display_mode': 'always', 'display_conditions': []} %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",g="{# Tire Pressure — bar per wheel, color changes at thresholds #}\n{% set wheels = [\n  {'entity': 'sensor.car_tyre_pressure_front_left',  'name': 'Front Left'},\n  {'entity': 'sensor.car_tyre_pressure_front_right', 'name': 'Front Right'},\n  {'entity': 'sensor.car_tyre_pressure_rear_left',   'name': 'Rear Left'},\n  {'entity': 'sensor.car_tyre_pressure_rear_right',  'name': 'Rear Right'}\n] %}\n{% set ns = namespace(mods=[]) %}\n{% for w in wheels %}\n  {% set psi = states(w.entity) | float(0) | round(1) %}\n  {% set color = '#f44336' if psi < 30 or psi > 38 else ('#ff9800' if psi < 32 or psi > 36 else '#4caf50') %}\n  {% set mod = {\n    'id': 'tyre_' ~ loop.index,\n    'type': 'bar',\n    'entity': w.entity,\n    'name': w.name ~ ' (' ~ psi ~ ' psi)',\n    'bar_color': color,\n    'display_mode': 'always',\n    'display_conditions': []\n  } %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",f="{# Lights — icon shows on/off, dimmer % shown in state text #}\n{% set lights = [\n  {'entity': 'light.living_room', 'name': 'Living Room'},\n  {'entity': 'light.kitchen',     'name': 'Kitchen'},\n  {'entity': 'light.bedroom',     'name': 'Bedroom'},\n  {'entity': 'light.hallway',     'name': 'Hallway'}\n] %}\n{% set ns = namespace(mods=[]) %}\n{% for l in lights %}\n  {% set is_on = states(l.entity) == 'on' %}\n  {% set brightness = (state_attr(l.entity, 'brightness') | int(0) / 255 * 100) | round(0) %}\n  {% set state_label = brightness ~ '%' if is_on else 'Off' %}\n  {% set icon_item = {\n    'id': 'li_' ~ loop.index,\n    'icon_mode': 'entity',\n    'entity': l.entity,\n    'name': l.name,\n    'icon_inactive': 'mdi:lightbulb-outline',\n    'icon_active':   'mdi:lightbulb',\n    'active_state':  'on',\n    'inactive_icon_color': '#9e9e9e',\n    'active_icon_color':   '#ffc107',\n    'show_name_when_inactive': true, 'show_state_when_inactive': true, 'show_icon_when_inactive': true,\n    'show_name_when_active':   true, 'show_state_when_active':   true, 'show_icon_when_active':   true\n  } %}\n  {% set mod = {'id': 'lt_' ~ loop.index, 'type': 'icon', 'icons': [icon_item], 'display_mode': 'always', 'display_conditions': []} %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",b="{# Temperature sensors — text with hot/cold color coding #}\n{% set sensors = [\n  {'entity': 'sensor.living_room_temperature', 'name': 'Living Room'},\n  {'entity': 'sensor.bedroom_temperature',     'name': 'Bedroom'},\n  {'entity': 'sensor.outdoor_temperature',     'name': 'Outdoor'},\n  {'entity': 'sensor.garage_temperature',      'name': 'Garage'}\n] %}\n{% set ns = namespace(mods=[]) %}\n{% for s in sensors %}\n  {% set temp = states(s.entity) | float(0) | round(1) %}\n  {% set unit = state_attr(s.entity, 'unit_of_measurement') | default('°') %}\n  {% set color = '#f44336' if temp > 26 else ('#2196f3' if temp < 18 else '#4caf50') %}\n  {% set mod = {\n    'id': 'temp_' ~ loop.index,\n    'type': 'text',\n    'text': s.name ~ ':  ' ~ temp ~ unit,\n    'color': color,\n    'display_mode': 'always',\n    'display_conditions': []\n  } %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",x="{# CPU & Memory bars — red above 80%, orange above 50% #}\n{% set sensors = [\n  {'entity': 'sensor.processor_use',    'name': 'CPU'},\n  {'entity': 'sensor.memory_use_percent','name': 'Memory'},\n  {'entity': 'sensor.disk_use_percent', 'name': 'Disk'}\n] %}\n{% set ns = namespace(mods=[]) %}\n{% for s in sensors %}\n  {% set val = states(s.entity) | float(0) | round(1) %}\n  {% set color = '#f44336' if val > 80 else ('#ff9800' if val > 50 else '#4caf50') %}\n  {% set mod = {\n    'id': 'sys_' ~ loop.index,\n    'type': 'bar',\n    'entity': s.entity,\n    'name': s.name ~ ' — ' ~ val ~ '%',\n    'bar_color': color,\n    'display_mode': 'always',\n    'display_conditions': []\n  } %}\n  {% set ns.mods = ns.mods + [mod] %}\n{% endfor %}\n{{ ns.mods | tojson }}",w="\n  background: rgba(var(--rgb-primary-color, 33,150,243), 0.1);\n  padding: 10px 14px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 8px;\n",$="\n  margin: 0;\n  padding: 12px 14px;\n  font-size: 11px;\n  line-height: 1.6;\n  background: var(--code-editor-background-color, #1e1e1e);\n  color: var(--code-editor-text-color, #d4d4d4);\n  font-family: 'Fira Code', Consolas, monospace;\n  overflow-x: auto;\n  white-space: pre-wrap;\n",k="\n  background: var(--primary-color);\n  color: white;\n  border: none;\n  border-radius: 6px;\n  padding: 6px 12px;\n  font-size: 12px;\n  font-weight: 600;\n  cursor: pointer;\n  white-space: nowrap;\n",S="\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 4px;\n  width: 100%;\n  padding: 8px 12px;\n  background: rgba(var(--rgb-primary-color, 33,150,243), 0.12);\n  color: var(--primary-color);\n  border: 1px solid rgba(var(--rgb-primary-color, 33,150,243), 0.3);\n  border-radius: 8px;\n  font-size: 13px;\n  font-weight: 600;\n  cursor: pointer;\n",z="\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: rgba(var(--rgb-primary-color, 33,150,243), 0.12);\n  color: var(--primary-color);\n  border: 1px solid rgba(var(--rgb-primary-color, 33,150,243), 0.3);\n  border-radius: 6px;\n  padding: 4px;\n  cursor: pointer;\n";class j extends n.m{constructor(){super(...arguments),this._templateService=null,this._todoService=null,this._expandedModules=new Map,this._currentPage=new Map,this._actionCache=new Map,this._actionFetching=new Set,this._actionTimers=new Map,this.metadata={type:"dynamic-list",title:"Dynamic List",description:"Generate a list of modules dynamically using a Jinja2 template",author:"WJD Designs",version:"1.0.0",icon:"mdi:code-braces",category:"layout",tags:["dynamic","template","jinja2","list","loop","layout"]}}_hashString(e){let t=0;for(let o=0;o<e.length;o+=1)t=(t<<5)-t+e.charCodeAt(o)&4294967295;return Math.abs(t).toString(36)}createDefault(e){return{id:e||this.generateId("dynamic-list"),type:"dynamic-list",source_type:"template",dynamic_template:_,todo_entity:void 0,todo_entities:[],todo_statuses:[],todo_item_template:{module_type:"text",primary_field:"summary",secondary_field:"due",icon:"mdi:checkbox-marked-circle-outline"},todo_dynamic_template:y,action_source:{domain:"todo",service:"get_items",service_data:{},watch_entities:[],refresh_interval:0},action_template:h,direction:"horizontal",gap:8,wrap:!0,columns:4,rows:0,limit:0,limit_behavior:"show_more",align_h:"center",align_v:"center",tap_action:{action:"nothing"},hold_action:{action:"nothing"},double_tap_action:{action:"nothing"},display_mode:"always",display_conditions:[]}}renderGeneralTab(e,t,o,n){var a,s,l,r,d,c,m,p,u,S,z,j,A,T,O,C,E,D,L;const q=e,J=(null===(a=null==t?void 0:t.locale)||void 0===a?void 0:a.language)||"en",M=(()=>{const e=String(q.source_type||"template").toLowerCase();return"todo"===e?"todo":"todo-template"===e?"todo-template":"action"===e?"action":"template"})(),U="todo"===M,I="todo-template"===M,N="action"===M,P=q.todo_item_template||{module_type:"text",primary_field:"summary",secondary_field:"due",icon:"mdi:checkbox-marked-circle-outline"};return i.qy`
      ...
      <div class="module-general-settings ultra-clean-form dynamic-list-editor">
        ...
        >
          ...
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-selector
              ...
              .value=${null!==(s=q.todo_entity)&&void 0!==s?s:""}
          ...
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-selector
              ...
              .value=${(()=>{const e=q.todo_statuses||[];return 0===e.length||2===e.length?"both":"completed"===e[0]?"completed":"needs_action"})()}
          ...
          <div class="field-group" style="margin-bottom: 8px;">
            ...
            <ha-selector
              ...
              .value=${P.module_type||"text"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{module_type:e.detail.value||"text"})})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 8px;">
            ...
            <ha-selector
              ...
              .value=${P.primary_field||"summary"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{primary_field:e.detail.value||"summary"})})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 8px;">
            ...
            <ha-selector
              ...
              .value=${null!==(l=P.secondary_field)&&void 0!==l?l:"due"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{secondary_field:"none"===e.detail.value?void 0:e.detail.value})})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-icon-picker
              .hass=${t}
              .value=${P.icon||"mdi:checkbox-marked-circle-outline"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{icon:e.detail.value||"mdi:checkbox-marked-circle-outline"})})}
            ></ha-icon-picker>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-icon-picker
              .hass=${t}
              .value=${null!==(d=null!==(r=P.icon_incomplete)&&void 0!==r?r:P.icon)&&void 0!==d?d:"mdi:checkbox-marked-circle-outline"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{icon_incomplete:e.detail.value||void 0})})}
            ></ha-icon-picker>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ultra-color-picker
              .hass=${t}
              .value=${null!==(c=P.icon_color_incomplete)&&void 0!==c?c:""}
              .defaultValue=${"var(--secondary-text-color)"}
              @value-changed=${e=>{var t;return n({todo_item_template:Object.assign(Object.assign({},P),{icon_color_incomplete:null!==(t=e.detail.value)&&void 0!==t?t:void 0})})}}
            ></ultra-color-picker>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-icon-picker
              .hass=${t}
              .value=${null!==(p=null!==(m=P.icon_completed)&&void 0!==m?m:P.icon)&&void 0!==p?p:"mdi:checkbox-marked-circle"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{icon_completed:e.detail.value||void 0})})}
            ></ha-icon-picker>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ultra-color-picker
              .hass=${t}
              .value=${null!==(u=P.icon_color_completed)&&void 0!==u?u:""}
              .defaultValue=${"var(--primary-color)"}
              @value-changed=${e=>{var t;return n({todo_item_template:Object.assign(Object.assign({},P),{icon_color_completed:null!==(t=e.detail.value)&&void 0!==t?t:void 0})})}}
            ></ultra-color-picker>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-selector
              ...
              .value=${null!==(S=P.icon_position)&&void 0!==S?S:"before"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{icon_position:e.detail.value||"before"})})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-selector
              ...
              .value=${null!==(z=P.alignment)&&void 0!==z?z:"left"}
              @value-changed=${e=>n({todo_item_template:Object.assign(Object.assign({},P),{alignment:e.detail.value||"left"})})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
            <ha-form
              .hass=${t}
              .data=${{allow_tap_to_complete:!0===P.allow_tap_to_complete}}
              ...
              @value-changed=${e=>{var t;return n({todo_item_template:Object.assign(Object.assign({},P),{allow_tap_to_complete:!0===(null===(t=e.detail.value)||void 0===t?void 0:t.allow_tap_to_complete)})})}}
            ></ha-form>
          </div>
          <div
            class="field-description"
        ...
        >
          ...
          <div class="field-group" style="margin-bottom: 12px;">
            ...
            <ha-selector
              .hass=${t}
              .selector=${{select:{options:[{value:"",label:"Default (first available)"},...t.states?Object.keys(t.states).filter((e=>e.startsWith("todo."))).map((e=>{var o,i;return{value:e,label:(null===(i=null===(o=t.states[e])||void 0===o?void 0:o.attributes)||void 0===i?void 0:i.friendly_name)||e}})):[]]}}}
              .value=${null!==(j=q.todo_entity)&&void 0!==j?j:""}
              @value-changed=${e=>n({todo_entity:e.detail.value||void 0})}
            ></ha-selector>
          </div>
          <div class="field-group" style="margin-bottom: 12px;">
        ...
        >
          ...
          ${(()=>{var e,o;const a=q.action_source||{domain:"",service:"",service_data:{},watch_entities:[],refresh_interval:0},s=e=>n({action_source:Object.assign(Object.assign({},a),e)});return i.qy`
              <div class="field-group" style="margin-bottom: 12px;">
                <ha-form
                  .hass=${t}
        ...
        >
          ...
          <div class="field-group">
            ...
            >
              ${(0,v.kg)("editor.dynamic_list.template_label",J,"Template")}
            </div>
            <div
              @mousedown=${e=>{const t=e.target;t.closest("ultra-template-editor")||t.closest(".cm-editor")||e.stopPropagation()}}
              @dragstart=${e=>e.stopPropagation()}
        ...
        >
          ...
          <div class="field-group" style="margin-bottom: 16px;">
            <label class="field-title" style="display:block; font-size: 14px; font-weight: 600; margin-bottom: 8px;">${(0,v.kg)("editor.dynamic_list.direction",J,"Direction")}</label>
            <ha-selector
              .hass=${t}
              .selector=${{select:{options:[{value:"horizontal",label:"Horizontal (side by side)"},{value:"vertical",label:"Vertical (stacked)"}]}}}
              .value=${q.direction||"horizontal"}
          ...
          <div class="field-group" style="margin-bottom: 16px;">
            <ha-form
              .hass=${t}
              .data=${{columns:null!==(A=q.columns)&&void 0!==A?A:0}}
              .schema=${[{name:"columns",label:"Columns",description:"horizontal"===(q.direction||"horizontal")?"Columns per row — items fill left to right then wrap (0 = auto size)":"Columns in the grid — items fill top to bottom per column (0 = single stack)",selector:{number:{min:0,max:12,step:1,mode:"slider"}}}]}
              .computeLabel=${e=>e.label||e.name}
              .computeDescription=${e=>e.description||""}
          ...
          ${"horizontal"===(q.direction||"horizontal")?i.qy`
          <div class="field-group" style="margin-bottom: 16px;">
            <ha-form
              .hass=${t}
              .data=${{rows:null!==(T=q.rows)&&void 0!==T?T:0}}
          ...
          <div class="field-group" style="margin-bottom: 16px;">
            <ha-form
              .hass=${t}
              .data=${{gap:null!==(O=q.gap)&&void 0!==O?O:8}}
              .schema=${[{name:"gap",label:(0,v.kg)("editor.dynamic_list.gap",J,"Gap (px)"),description:(0,v.kg)("editor.dynamic_list.gap_desc",J,"Space between generated modules in pixels"),selector:{number:{min:0,max:64,step:1,unit_of_measurement:"px",mode:"slider"}}}]}
              .computeLabel=${e=>e.label||e.name}
              .computeDescription=${e=>e.description||""}
          ...
          <div class="field-group" style="margin-bottom: 16px;">
            ...
            <ha-selector
              ...
              .value=${null!==(C=q.sort_by)&&void 0!==C?C:"default"}
              @value-changed=${e=>n({sort_by:e.detail.value||"default"})}
            ></ha-selector>
          </div>

          ${q.sort_by&&"default"!==q.sort_by?i.qy`
          <div class="field-group" style="margin-bottom: 16px;">
            ...
            <ha-selector
              ...
              .value=${null!==(E=q.sort_direction)&&void 0!==E?E:"asc"}
          ...
          <div class="field-group" style="margin-bottom: 16px;">
            <ha-form
              .hass=${t}
              .data=${{limit:null!==(D=q.limit)&&void 0!==D?D:0}}
          ...
          ${(null!==(L=q.limit)&&void 0!==L?L:0)>0?i.qy`
          <div class="field-group">
            ...
            <ha-selector
              ...
              .value=${q.limit_behavior||"show_more"}
...
{{ ns.mods | tojson }}                {# Step 3 — output as JSON        #}</pre>
 ...
 'display_mode': 'always', 'display_conditions': []}</pre>
    ...
    `}renderActionsTab(e,t,o,i){return a.A.render(e,t,(e=>i(e)))}renderOtherTab(e,t,o,i){return s.X.render(e,t,(e=>i(e)))}_parseDescriptionJson(e){if(!e||"string"!=typeof e)return null;const t=e.trim();if(t.startsWith("{")&&t.endsWith("}")||t.startsWith("[")&&t.endsWith("]"))try{const e=JSON.parse(t);return"object"==typeof e&&null!==e?e:null}catch(e){return null}return null}_mapTodoItemsToModules(e,t,o,i){var n,a,s,l;const r=Array.isArray(t)&&t.length>0?e.filter((e=>t.includes(e.item.status))):e,d=o.icon||"mdi:checkbox-marked-circle-outline",c=null!==(a=null!==(n=o.icon_incomplete)&&void 0!==n?n:o.icon)&&void 0!==a?a:d,m=null!==(l=null!==(s=o.icon_completed)&&void 0!==s?s:o.icon)&&void 0!==l?l:"mdi:checkbox-marked-circle",p=[];return r.forEach((({item:e,entityId:t},n)=>{var a,s,l;const r=`${i}_todo_${n}_${(e.uid||n).toString().slice(0,8)}`,d=(e=>{const t=o.primary_field||"summary";return"summary"===t?e.summary||"":"description"===t?e.description||"":"due"===t?e.due||"":"status"===t?"completed"===e.status?"Done":"To do":e.summary||""})(e),u=(e=>{const t=o.secondary_field;return t&&"none"!==t?"summary"===t?e.summary||"":"description"===t?e.description||"":"due"===t?e.due||"":"status"===t?"completed"===e.status?"Done":"To do":"":""})(e),v=d,y=this._parseDescriptionJson(e.description);if(Array.isArray(y)&&y.length>0)return void y.forEach(((e,t)=>{if(e&&"object"==typeof e&&!Array.isArray(e)){const o=e,i=o.id||`${r}_${t}`,n=Object.assign(Object.assign({},o),{id:"string"==typeof i?i:`${r}_${t}`,display_mode:o.display_mode||"always",display_conditions:Array.isArray(o.display_conditions)?o.display_conditions:[]});p.push(n)}}));let h;if("icon"===o.module_type){const i="completed"===e.status;h={id:r,type:"icon",icons:[{id:`${r}_icon`,icon_mode:"static",entity:t,name:v,icon_inactive:i?m:c,icon_active:m,inactive_icon_color:i?null!==(a=o.icon_color_completed)&&void 0!==a?a:"var(--primary-color)":null!==(s=o.icon_color_incomplete)&&void 0!==s?s:"var(--secondary-text-color)",active_icon_color:null!==(l=o.icon_color_completed)&&void 0!==l?l:"var(--primary-color)",show_name_when_inactive:!0,show_state_when_inactive:!1,show_icon_when_inactive:!0,show_name_when_active:!0,show_state_when_active:!1,show_icon_when_active:!0}],display_mode:"always",display_conditions:[]}}else{const i=u?`${d} — ${u}`:d,n="completed"===e.status,a={id:r,type:"text",text:i,display_mode:"always",display_conditions:[],icon:n?m:c,icon_color:n?o.icon_color_completed:o.icon_color_incomplete,icon_position:("none"===o.icon_position?"none":o.icon_position)||"before",alignment:o.alignment||"left"};o.allow_tap_to_complete&&e.uid&&(a.tap_action={action:"perform-action",service:"todo.update_item",target:{entity_id:t},service_data:{item:e.uid,status:n?"needs_action":"completed"}}),h=a}if(y&&!Array.isArray(y)&&"object"==typeof y){const e=y,t=Object.assign(Object.assign({},h),e);t.id||(t.id=h.id),t.display_mode||(t.display_mode="always"),void 0===t.display_conditions&&(t.display_conditions=[]),p.push(t)}else p.push(h)})),p}renderPreview(e,t,o,n){var a,s,r,v,y,h,_,g,f,b,x,w,$,k,j,A,T;const O=e,C=(()=>{const e=String(O.source_type||"template").toLowerCase();return"todo"===e?"todo":"todo-template"===e?"todo-template":"action"===e?"action":"template"})();if(!t)return this.renderGradientErrorState("Waiting for Home Assistant","This module requires a live connection","mdi:loading");let E=[];if("todo"===C){const e=t.states&&Object.keys(t.states).find((e=>e.startsWith("todo."))),o=t=>((null==t?void 0:t.trim())||e||"").trim(),n=o(null!==(a=O.todo_entity)&&void 0!==a?a:""),s=(O.todo_entities||[]).map((e=>o(e))).filter((e=>e&&e!==n)),l=n?[n,...s]:s.length?s:e?[e]:[];if(0===l.length)return this.renderGradientErrorState("No Todo List",'Add a to-do list (e.g. Local Todo) or choose one in the General tab. Use "Default (first available)" when you have at least one todo entity.',"mdi:format-list-checks");this._todoService||(this._todoService=new d);const r=t.__uvc_todo_cache,c=()=>{"undefined"!=typeof window&&(window._ultraCardUpdateTimer||(window._ultraCardUpdateTimer=setTimeout((()=>{window.dispatchEvent(new CustomEvent("ultra-card-template-update")),window._ultraCardUpdateTimer=null}),50)))};let m=!1;for(const e of l)void 0===(null==r?void 0:r[e])&&(m=!0,this._todoService.getItems(t,e,c));if(m)return i.qy`
        ...
        `;if(Array.isArray(s))E=s;else if(null!==s&&"object"==typeof s)E=[];else try{const e=JSON.parse(String(s).trim());E=Array.isArray(e)?e:[]}catch(e){return console.error("[UltraCard] Dynamic List: failed to parse template output:",s,e),this.renderGradientErrorState("Invalid Template Output","Template must output a JSON array. End your template with {{ ns.mods | tojson }}.","mdi:alert-circle-outline")}const r=O.sort_by||"default",d=O.sort_direction||"asc";if("summary"===r&&E.length>0){const e="asc"===d?1:-1,t=e=>{var t,o,i,n,a;return(null!==(a=null!==(o=null!==(t=e.text)&&void 0!==t?t:e.name)&&void 0!==o?o:null===(n=null===(i=e.icons)||void 0===i?void 0:i[0])||void 0===n?void 0:n.name)&&void 0!==a?a:"").toString().toLowerCase()};E=[...E].sort(((o,i)=>e*(t(o)<t(i)?-1:t(o)>t(i)?1:0)))}}if(0===E.length){const e="todo"===C||"todo-template"===C,t=e?"No to-do items":"Template returned an empty list";return i.qy`
        <div
          style="
            display: flex;
            align-items: center;
      ...
      `}const D=(0,m.oD)(),L=O.direction||"horizontal",q=null!==(w=O.gap)&&void 0!==w?w:8,J=!1!==O.wrap,M=null!==($=O.columns)&&void 0!==$?$:4,U=null!==(k=O.rows)&&void 0!==k?k:0,I=null!==(j=O.limit)&&void 0!==j?j:0,N=O.limit_behavior||"show_more",P=O.align_h||"center",B=O.align_v||"center",W=O.id;let G=E;if(U>0&&"horizontal"===L){const e=M>0?U*M:U;G=E.slice(0,e)}const R=I>0&&I<G.length;let H=G,F=i.qy``;if(R)if("show_more"===N){const e=null!==(A=this._expandedModules.get(W))&&void 0!==A&&A;H=e?G:G.slice(0,I);const t=G.length-I;F=e?i.qy`
              ...
              <button style="${S}" @click=${()=>{this._expandedModules.set(W,!0),window.dispatchEvent(new CustomEvent("ultra-card-template-update"))}}>
                ...
                Show ${t} more
              </button>`}else{const e=Math.ceil(G.length/I),t=Math.min(null!==(T=this._currentPage.get(W))&&void 0!==T?T:0,e-1);H=G.slice(t*I,t*I+I),F=i.qy`
          <div style="${"\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 12px;\n  padding: 4px 0;\n"}">
            <button
              style="${z}${0===t?"opacity:0.35;pointer-events:none;":""}"
            ...
            <button
              style="${z}${t>=e-1?"opacity:0.35;pointer-events:none;":""}"
          ...
          </div>`}const K=M>0,V=K?`display:grid;grid-template-columns:repeat(${M},1fr);gap:${q}px;width:100%;justify-items:${"space-between"===P||"space-around"===P?"center":P};align-items:${B};`:"horizontal"===L?`display:flex;flex-direction:row;flex-wrap:${J?"wrap":"nowrap"};gap:${q}px;width:100%;justify-content:${P};align-items:${B};`:`display:flex;flex-direction:column;gap:${q}px;width:100%;align-items:${"space-between"===P||"space-around"===P?"center":P};justify-content:${B};`,Z=!K&&"horizontal"===L,Y=H.map((e=>{var a,s,l,r,d,c,m,v;if(!p.S.evaluateModuleVisibility(e))return i.qy``;const y=D.getModule(e.type);if(!y)return i.qy`<div style="font-size:11px; color: var(--warning-color); padding: 4px;">Unknown module type: ${e.type}</div>`;const h=(null===(s=null===(a=y.metadata)||void 0===a?void 0:a.tags)||void 0===s?void 0:s.includes("pro"))||(null===(r=null===(l=y.metadata)||void 0===l?void 0:l.tags)||void 0===r?void 0:r.includes("premium"))||!1;let _=!1;const g=u.x.checkIntegrationAuth(t);if("pro"===(null===(d=null==g?void 0:g.subscription)||void 0===d?void 0:d.tier)&&"active"===(null===(c=null==g?void 0:g.subscription)||void 0===c?void 0:c.status))_=!0;else if(u.x.isAuthenticated()){const e=u.x.getCurrentUser();"pro"===(null===(m=null==e?void 0:e.subscription)||void 0===m?void 0:m.tier)&&"active"===(null===(v=null==e?void 0:e.subscription)||void 0===v?void 0:v.status)&&(_=!0)}if(h&&!_)return i.qy`<div style="font-size:11px; color: var(--warning-color); padding: 4px;">🔒 Pro module</div>`;const f=Object.assign(Object.assign(Object.assign(Object.assign({},O.design||{}),void 0!==O.font_size&&null!==O.font_size&&{font_size:O.font_size}),void 0!==O.color&&null!==O.color&&{color:O.color}),void 0!==O.font_family&&null!=O.font_family&&{font_family:O.font_family}),b=Object.assign(Object.assign({},e),{design:Object.assign(Object.assign({},f),e.design||{})}),x=y.renderPreview(b,t,o,n),w=K||"vertical"!==L||"center"!==P&&"end"!==P?"":`width: fit-content; max-width: 100%; align-self: ${"center"===P?"center":"flex-end"};`,$=w?i.qy`<div style="${w}">${x}</div>`:x;return Z?i.qy`<div style="${"flex: 0 0 auto; min-width: 0;"}">${$}</div>`:$}));return i.qy`
